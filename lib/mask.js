...
(function(root, factory) {
 ...
 // charCode
        ...
        var nodes = fragment.nodes;
        var result = null != nodes && 1 === nodes.length ? nodes[0] : fragment;
      ...
      (function() {
        ...
        IFStatement.prototype = {
          ...
          refresh: function() {
            ...
            var parentNodeName = this.node.parent.tagName;
            var parentGetsElements = 'define' === parentNodeName || 'let' === parentNodeName;
            ...
            var els = compo_renderElements(nodes, model, ctx, frag, owner);
            dom_insertBefore(frag, this.placeholder);
            current.elements = els;
