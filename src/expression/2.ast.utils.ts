import { type_Body, type_Statement, type_Accessor, type_AccessorExpr, type_UnaryPrefix, type_SymbolRef, type_FunctionRef, PRECEDENCE } from './1.scope-vars';
import { util_throw } from './3.util';
import { Ast_Body } from './2.ast';

export function ast_remove  (parent, child) {
