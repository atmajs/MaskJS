          ...
          compo_inherit = function(Proto, Extends) {
            ...
            while (--i > -1) {
              ...
              if ('function' === typeof x) {
                ...
                ctors.push(x);
                x = x.prototype;
                /** ES6 Classes: methods are not enumarable, which is needed in `inherit_` method: so convert prototype to hash */                if (i === imax - 1 && null != getProtoOf) {
