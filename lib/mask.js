 ...
 *
 * (c) 2012, 2019 Atma.js and other contributors
 */
(function(root, factory) {
  ...
  'use strict';
  var fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, arr_remove, arr_each, arr_contains, arr_pushMany, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, ModuleMidd, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, __rgxEscapedChar, expression_getHost, expression_bind, obj_addObserver, obj_removeObserver, expression_createListener, expression_createBinder, expression_callFn, expression_unbind, obj_addObserver, obj_hasObserver, obj_removeObserver, obj_lockObservers, obj_unlockObservers, obj_addMutatorObserver, obj_removeMutatorObserver, expression_bind, expression_unbind, expression_callFn, expression_createBinder, expression_createListener, expression_getHost, arr_remove, arr_each, arr_contains, arr_pushMany, prop_OBS, prop_MUTATORS, prop_TIMEOUT, prop_DIRTY, prop_PROXY, obj_defineProp, obj_ensureFieldDeep, obj_ensureObserversProperty, obj_getObserversProperty, obj_ensureRebindersProperty, obj_chainToProp, objMutator_addObserver, objMutator_removeObserver, getSelfMutators, obj_defineCrumbs, obj_sub_notifyListeners, obj_deep_notifyListeners, obj_callMethod, arr_remove, arr_each, arr_contains, arr_pushMany, coll_each, coll_indexOf, coll_remove, coll_map, coll_find, __rgxEscapedChar, __rgxEscapedChar, coll_each, coll_indexOf, coll_remove, coll_map, coll_find, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, arr_remove, arr_each, arr_contains, arr_pushMany, coll_each, coll_indexOf, coll_remove, coll_map, coll_find, coll_each, coll_indexOf, coll_remove, coll_map, coll_find, arr_remove, arr_each, arr_contains, arr_pushMany, coll_each, coll_indexOf, coll_remove, coll_map, coll_find, arr_remove, arr_each, arr_contains, arr_pushMany, arr_remove, arr_each, arr_contains, arr_pushMany, attr_first, attr_first, Methods, defMethods_getSource, defMethods_compile, nodeMethod_getSource, nodeMethod_compile, sourceUrl_get, _args_toCode, scopeRefs_getImportVars, sourceUrl_get, _args_toCode, scopeRefs_getImportVars, Define, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, Methods, coll_each, coll_indexOf, coll_remove, coll_map, coll_find, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, Define, ModuleMidd, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, coll_each, coll_indexOf, coll_remove, coll_map, coll_find, arr_remove, arr_each, arr_contains, arr_pushMany, arr_remove, arr_each, arr_contains, arr_pushMany, expression_getHost, expression_bind, obj_addObserver, obj_removeObserver, expression_createListener, expression_createBinder, expression_callFn, expression_unbind, coll_each, coll_indexOf, coll_remove, coll_map, coll_find, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, arr_remove, arr_each, arr_contains, arr_pushMany, arr_remove, arr_each, arr_contains, arr_pushMany, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, arr_remove, arr_each, arr_contains, arr_pushMany, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern;
  ...
  (function() {
    ...
    function event_trigger() {
      var fn, imax, args = _Array_slice.call(arguments), event = args.shift(), fns = this._listeners[event], i = 0;
      if (null == fns) {
        return this;
      }
  ...
  (function() {
    ...
    var Component;
    (function() {
      Component = function(compoName, parent, controller) {
  ...
  var expression_eval, expression_evalStatements, expression_varRefs, ExpressionUtil;
  (function() {
 ...
 // 16
            ...
            (function() {
              ...
              (function() {
                obj_addObserver = function(obj, property, cb) {
                  ...
                  // closest observer
                                    var parts = property.split('.'), i = (parts.length, -1);
                  if (pushClosest(obj[parts[0]], parts, 1, cb)) {
                    ...
                    if (1 === cbs.length) {
                      ...
                      if (0 !== arr.length) {
                        attachProxy_(obj, property, cbs, arr);
                      }
                    }
                    if (parts.length > 1) {
                  ...
                  cbs = pushListener_(obj, property, cb);
                  if (1 === cbs.length) {
              ...
              function attachProxy_(obj, property, cbs, chain) {
                ...
                // TODO: ensure is not required, as defineCrumbs returns false when path contains null value */
                                var parent = length > 1 ? obj_ensureFieldDeep(obj, chain) : obj, key = chain[length - 1], currentVal = parent[key];
                if ('length' === key) {
  ...
  (function() {
    var builder_buildFactory, builder_findAndRegisterCompo, builder_pushCompo, builder_setCompoModel, builder_setCompoAttributes, builder_setCompoProps, build_manyFactory, build_nodeFactory, build_compoFactory, build_textNode, decorators_buildFactory, builder_buildDelegate;
    (function() {
    ...
    (function() {
      ...
      (function() {
        obj_getPropertyEx = function(path, model, ctx, ctr) {
          ...
          var props = path.split('.'), imax = props.length, key = props[0];
          if ('$c' === key || '$' === key) {
      ...
      function _split(template) {
        var nextC, nextI, index = -1, wasEscaped = false;
        /*
 ...
 //{}
  ...
  (function() {
    var compo_meta_toAttributeKey, compo_meta_prepairAttributesHandler, compo_meta_prepairArgumentsHandler, Anchor, compo_dispose, compo_detachChild, compo_ensureTemplate, compo_attachDisposer, compo_attach, compo_removeElements, compo_cleanElements, compo_prepairAsync, compo_errored, CompoSignals, compo_find, compo_findAll, compo_closest, compo_children, compo_child, CompoStaticsAsync, _fire, _hasSlot, _toggle_all, _toggle_single, _compound, dom_addEventListener, node_tryDispose, node_tryDisposeChildren, TouchHandler, isTouchable, event_bind, event_unbind, event_trigger, Touch, FastClick, domLib_find, domLib_on, CompoConfig, domLib_find, domLib_on, domLib_initialize, dom_addEventListener, node_tryDispose, node_tryDisposeChildren, compo_create, compo_prepairProperties, CompoStatics, compo_meta_toAttributeKey, compo_meta_prepairAttributesHandler, compo_meta_prepairArgumentsHandler, compo_inherit, Pipes, dom_addEventListener, node_tryDispose, node_tryDisposeChildren, compo_dispose, compo_detachChild, compo_ensureTemplate, compo_attachDisposer, compo_attach, compo_removeElements, compo_cleanElements, compo_prepairAsync, compo_errored, compo_dispose, compo_detachChild, compo_ensureTemplate, compo_attachDisposer, compo_attach, compo_removeElements, compo_cleanElements, compo_prepairAsync, compo_errored, dom_addEventListener, node_tryDispose, node_tryDisposeChildren, CompoSignals, DomLite, CompoStaticsAsync, compo_find, compo_findAll, compo_closest, compo_children, compo_child, Anchor, CompoConfig, Pipes, domLib_initialize, CompoStatics, compo_create, compo_prepairProperties;
    ...
    (function() {
      (function() {
        ...
        /*out*/ hash) {
          ...
          var property = isAttr ? _getProperty(attrName) : attrName, fn = null, type = typeof metaVal;
          if ('string' === type) {
            ...
            (function() {
              ...
              (function() {
                ...
                function prepairTouchEvent(event) {
                  var touch = null, touches = event.changedTouches;
                  if (touches && touches.length) {
                    touch = touches[0];
                  }
                  if (null == touch && event.touches) {
      ...
      CompoProto = {
        ...
        setAttribute: function(key, val) {
          var attr = this.meta.attributes;
          var meta = null == attr ? void 0 : attr[key];
          var prop = null;
          if (void 0 !== meta) {
            prop = compo_meta_toAttributeKey(key);
          } else {
            var props = this.meta.properties;
            meta = null == props ? void 0 : props[key];
            if (void 0 !== meta) {
              prop = key;
            }
          }
      ...
      (function() {
        (function() {
          ...
          compo_inherit = function(Proto, Extends) {
            var x, hasBase, imax = Extends.length, i = imax, ctors = [];
            while (--i > -1) {
              x = Extends[i];
              if ('string' === typeof x) {
                x = customTag_get(x);
          ...
          function inherit_(target, source, name) {
            ...
            if ('node' === name) {
              ...
              target.template = null == targetNodes || null == sourceNodes ? targetNodes || sourceNodes : mask_merge(sourceNodes, targetNodes, target, {
                extending: true
              });
              if (null != target.nodes) {
                target.nodes = target.template;
              }
            }
            var hasFnOverrides = false;
            outer: for (var key in source) {
              if ('constructor' === key || 'node' === name && ('template' === key || 'nodes' === key)) {
                continue;
              }
              var mix = source[key];
              if (null == target[key]) {
            ...
            if (true === hasFnOverrides) {
              if (null != target['super']) {
                log_error('`super` property is reserved. Dismissed. Current prototype', target);
              }
              target['super'] = null;
            }
          }
          /*! Circular references are not handled */          function defaults_(target, source) {
            var targetV, sourceV;
          ...
          (function() {
            ...
            function ensureCallable(fns) {
              var out = [], i = fns.length;
              while (--i > -1) {
                out[i] = ensureCallableSingle(fns[i]);
              }
              return out;
            }
        ...
        compo_create = function(arguments_) {
          var Ctor, hasBase, argLength = arguments_.length, Proto = arguments_[argLength - 1];
          if (argLength > 1) {
        ...
        function compo_createConstructor(Ctor, proto, hasBaseAlready) {
  ...
  (function() {
    ...
    function _mergeNode(node, placeholders, tmplNode, clonedParent) {
      ...
      if (tag_EACH === tagName) {
        ...
        while (++i < imax) {
          x = arr[i];
          appendAny(fragment, _merge(node.nodes, _resolvePlaceholders(x.nodes, x.nodes, new Placeholders(placeholders)), x, clonedParent));
        }
        return fragment;
      }
      if (tag_IF === tagName) {
    ...
    function interpolate_obj_(obj, placeholders, node) {
      var x, clone = _Object_create(obj);
  ...
  (function() {
    ...
    (function() {
      (function() {
        ...
        var rgx_PROTOCOL = /^(file|https?):/i, rgx_SUB_DIR = /[^\/\.]+\/\.\.\//, rgx_FILENAME = /\/[^\/]+\.\w+(\?.*)?(#.*)?$/, rgx_EXT = /\.(\w+)$/;
    ...
    (function() {
      ...
      ModuleMask = m_Types['mask'] = class_create(IModule, {
        ...
        preprocess_: function(mix, next) {
          ...
          var x, arr = _nodesToArray(ast), importNodes = [], imax = arr.length, i = -1;
          while (++i < imax) {
            x = arr[i];
            switch (x.tagName) {
             case 'import':
    ...
    (function() {
      ...
      var ComponentStrategy = class_create(IStrategy, {
        ...
        render: function(model, ctx, container) {
          this.awaitable = new AwaitableRender(this.name, this.expr, this.getNodes_(), model, ctx, container, this.awaiter);
          this.awaitable.pipe(this);
        },
        getNodes: function() {
          return null;
      ...
      var AwaitableRender = class_create(class_Dfr, {
        constructor: function(name, expression, nodes, model, ctx, container, ctr) {
          ...
          renderer_renderAsync(node, model, builder_Ctx.clone(ctx), null, ctr).then(this.onComplete, this.rejectDelegate());
        },
    ...
    (function() {
      function getNodes(node, model, ctx, ctr) {
        ...
        while (true) {
          ...
          var expr = node.expression;
          if (null == expr || '' === expr || evaluate(expr)) {
            return node.nodes;
          }
        }
        return null;
  ...
  (function() {
    ...
    (function() {
      ...
      BindingProvider = /** @class */ function() {
        function BindingProvider(model, element, ctr, bindingType) {
          ...
          if (isCompoBinder && (1 !== element.nodeType || 'INPUT' !== element.tagName)) {
        ...
        BindingProvider.prototype.objectChanged = function(val) {
          ...
          if (this.signal_objectChanged) {
            Component.signal.emitOut(this.ctr, this.signal_objectChanged, this.ctr, [ val ]);
          }
          if (null != this.pipe_objectChanged) {
      ...
      function apply_bind(provider) {
        ...
        if ('dual' === provider.bindingType) {
          ...
          if (!attr['dom-slot'] && !attr['change-pipe-event']) {
            var element = provider.element, eventType = provider.changeEvent, onDomChange = provider.domChanged.bind(provider), doListen = Component.Dom.addEventListener;
            if (-1 !== eventType.indexOf(',')) {
    ...
    (function() {
      var arr_createRefs, list_sort, list_update, list_remove, LoopStatementProto, dom_removeAll, dom_insertAfter, dom_insertBefore, compo_fragmentInsert, compo_renderChildren, compo_renderElements, compo_dispose, compo_disposeChildren, compo_inserted;
      ...
      (function() {
        ...
        (function() {
          ...
          compo_renderChildren = function(compo, anchor, model) {
            ...
            compo.elements = compo_renderElements(compo.nodes, model || compo.model, compo.ctx, fragment, compo);
    ...
    (function() {
      (function() {
        ...
        function bind(current, expr, model, ctx, element, ctr, attrName, type) {
          var refresher = create_refresher(type, expr, element, current, attrName, ctr), binder = expression_createBinder(expr, model, ctx, ctr, refresher);
