										...
										(function(){
											deco_slot = function (mix) {
											    return function (target, propertyKey, descriptor) {
											        var _a, _b, _c, _d;
											        var slots = (_a = target.slots, (_a !== null && _a !== void 0 ? _a : (target.slots = {})));
											        var name = typeof mix === 'string' ? mix : (_b = mix) === null || _b === void 0 ? void 0 : _b.name;
											        var isPrivate = typeof mix !== 'string' ? (_d = (_c = mix) === null || _c === void 0 ? void 0 : _c.private, (_d !== null && _d !== void 0 ? _d : false)) : false;
											...
											deco_pipe = function (pipeName, signalName) {
											    return function (target, propertyKey, descriptor) {
											        var _a, _b;
											        var pipes = (_a = target.pipes, (_a !== null && _a !== void 0 ? _a : (target.pipes = {})));
											        var stream = (_b = pipes[pipeName], (_b !== null && _b !== void 0 ? _b : (pipes[pipeName] = {})));
											        var viaProperty = descriptor == null;
											        var fn = viaProperty ? target[propertyKey] : descriptor.value;
											...
											deco_event = function (selector) {
											    return function (target, propertyKey, descriptor) {
											        var _a;
											        var events = (_a = target.events, (_a !== null && _a !== void 0 ? _a : (target.events = {})));
											        var viaProperty = descriptor == null;
											        var fn = viaProperty ? target[propertyKey] : descriptor.value;
											        events[selector] = fn;
											        return descriptor;
											...
											deco_hotkey = function (hotkey) {
											    return function (target, propertyKey, descriptor) {
											        var _a;
											        var hotkeys = (_a = target.hotkeys, (_a !== null && _a !== void 0 ? _a : (target.hotkeys = {})));
											        var viaProperty = descriptor == null;
											        var fn = viaProperty ? target[propertyKey] : descriptor.value;
											        hotkeys[hotkey] = fn;
											        return descriptor;
