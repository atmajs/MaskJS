...
//# sourceMappingURL=Uri.es6.map
	...
	(function(){
		...
		// source ./transform/css.js
		
		// end:source ./transform/css.js
		// source ./transform/mask.js
		
		// end:source ./transform/mask.js
	
		ScopedCss = {
	
			transformCss: function (str) {
	
			},
	
			// @mix - mask ast or mask template
			transformMask: function(mix, scopedCss) {
	
			}
		}
	}());
	// end:source scoped-css/
	// source Define
	var Define;
	(function(){
		Define = {
