			...
			(function(){
				...
				(function(){
					...
					customTag_register = function (mix, Handler) {
					    ...
					    var Current = custom_Tags[mix], Ctor = compo_ensureCtor(Handler), Repo = custom_Tags[mix] === Resolver ? custom_Tags_global : custom_Tags;
					    Repo[mix] = Ctor;
													...
													(function(){
														(function(){
															...
															function compo_extends(extends_, model, ctr) {
															    ...
															    if (extends_ == null)
															        return args;
															    var imax = extends_.length, i = -1, await = 0, x;
															    while (++i < imax) {
															        x = extends_[i];
															        if (x.compo) {
										...
										(function(){
											(function(){
												...
												compo_inherit = function (Proto, Extends) {
												    var imax = Extends.length, i = imax, ctors = [], x, hasBase;
												    while (--i > -1) {
												        x = Extends[i];
												        if (typeof x === 'string') {
												            x = customTag_get(x);
											...
											compo_create = function (arguments_) {
											    var argLength = arguments_.length, Proto = arguments_[argLength - 1], Ctor, hasBase;
											    if (argLength > 1)
										...
										(function(){
											...
											(function () {
											    obj_addObserver = function (obj, property, cb) {
											        if (obj == null) {
											            log_error('Not possible to add the observer for "' +
											                property +
											...
											obj_removeObserver = function (obj, property, callback) {
											    if (obj == null) {
											        log_error('Not possible to remove the observer for "' +
											            property +
											            '" as current model is undefined.');
											        return;
											    }
							...
							var AwaitableRender = class_create(class_Dfr, {
							    constructor: function (name, expression, nodes, model, ctx, container, ctr) {
							        ...
							        renderer_renderAsync(node, model, builder_Ctx.clone(ctx), null, ctr)
							            .then(this.onComplete, this.rejectDelegate());
							    },
