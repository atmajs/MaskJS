...
import { obj_addMutatorObserver, obj_addObserver, obj_removeMutatorObserver, obj_removeObserver } from './object_observe';
import { obj_callFn } from './object';
...
export function expression_createBinder (expr, model, ctx, ctr, fn) {
		return expression_createListener(function(){
			var value = expression_eval_safe(expr, model, ctx, ctr);
