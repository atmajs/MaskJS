										...
										(function(){
											(function(){
												(function(){
													...
													var polyfill_class_wrap_es5_inner = function (Base, beforeFn, afterFn, callCtors) {
													    return /** @class */ (function (_super) {
													        ...
													        function class_1() {
													            ...
													            if (beforeFn != null) {
													                beforeFn.apply(_this, args);
													            }
													            if (callCtors != null) {
													                for (var i = callCtors.length - 1; i > -1; i--) {
													                    callCtors[i](_this, args);
													                }
													            }
													            if (afterFn != null) {
													                afterFn.apply(_this, args);
													            }
													            return _this;
													        }
													        return class_1;
										...
										(function(){
											deco_slot = function (name) {
											    return function (target, propertyKey, descriptor) {
											        ...
											        slots[(name !== null && name !== void 0 ? name : propertyKey)] = fn;
											        return descriptor;
											    };
											}
											;
											deco_attr = function (opts) {
											    return function (target, propertyKey, descriptor) {
											        ...
											        var name = (_a = opts) === null || _a === void 0 ? void 0 : _a.name;
											        if (name == null) {
											...
											function ensureMeta(proto, name) {
											    ...
											    return _b = m[name], (_b !== null && _b !== void 0 ? _b : (m[name] = {}));
											}
											function ensureRef(proto, key, selector, refName) {
											    var _a;
											    var refs = ensureMeta(proto, 'refs');
											    var ref = (_a = refs[refName], (_a !== null && _a !== void 0 ? _a : (refs[refName] = {})));
											    ref[key] = selector;
											}
