...
import { type_FunctionRef, type_AccessorExpr, type_Accessor } from './1.scope-vars';
import { _evaluateAst } from './6.eval';

declare var global;

export function util_throw (template: string, index: number, msg: string, token?, astNode?){
