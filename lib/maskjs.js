        ...
        parseAttributes: function(T, node) {
            ...
            for (; T.index < T.length; T.index++) {
                ...
                case 62:
                    ...
                    if (_classNames != null) {
                        node.attr.class = _classNames.indexOf('#{') > -1 ? this.toFunction(_classNames) : _classNames;
                    }
                    return;
        ...
        parse: function(T, nodes) {
            ...
            for (; T.index < T.length; T.index++) {
                ...
                case 39: // "'"
                    ...
                    if (content.indexOf('#{') > -1) content = this.toFunction(content);
                ...
                while (c !== 32 && c !== 35 && c !== 46 && c !== 59 && c !== 123);
                /** while !: ' ', # , . , ; , { */
