      ...
      (function() {
        ...
        (function() {
          (function() {
            ...
            env_class_overrideArgs = ENV_CLASS ? new Function('Ctor', 'innerFn', '\n    return class extends Ctor {\n        constructor (...args) {\n            super(...innerFn(...args));\n        }\n    }\n') : function(Ctor, innerFn) {
            ...
            var polyfill_class_wrap_inner = ENV_CLASS ? new Function('Base', 'beforeFn', 'afterFn', 'callCtors', '\nreturn class extends Base {\n    constructor (...args) {\n        super(...args);\n        if (beforeFn != null) {\n            beforeFn.apply(this, args);\n        }\n        if (callCtors != null) {\n            for (let i = callCtors.length - 1; i > -1; i--) {\n                callCtors[i](this, args);\n            }\n        }\n        if (afterFn != null) {\n            afterFn.apply(this, args);\n        }\n    }\n}\n') : function(Base, beforeFn, afterFn, callCtors) {
