          ...
          (function() {
            (function() {
              ...
              compo_addChildren = function(ctr) {
                ...
                var x = ctr.components;
                if (null == x) {
                  ctr.components = compos;
                  return;
                }
                compos.push.apply(compos, compos);
              };
    ...
    (function() {
      ...
      var ObservableIf = /** @class */ function() {
        ...
        ObservableIf.prototype.refresh = function(err, node, index) {
          ...
          compo_addChildren.apply(void 0, [ this.ctr ].concat(owner.components));
        };
