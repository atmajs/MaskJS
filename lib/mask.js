...
(function(root, factory) {
  ...
  'use strict';
  var fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, arr_remove, arr_each, arr_contains, arr_pushMany, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, customTag_get, customTag_getAll, customTag_register, customTag_registerFromTemplate, customTag_registerScoped, customTag_define, customTag_registerResolver, customTag_Compo_getHandler, customTag_Base, customTag_Resolver, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, ModuleMidd, _parseCached, _parse, _evaluate, _evaluateAst, op_Minus, op_Plus, op_Divide, op_Multip, op_Modulo, op_LogicalOr, op_NullishCoalescing, op_LogicalAnd, op_LogicalNot, op_LogicalEqual, op_LogicalEqual_Strict, op_LogicalNotEqual, op_LogicalNotEqual_Strict, op_LogicalGreater, op_LogicalGreaterEqual, op_LogicalLess, op_LogicalLessEqual, op_AsyncAccessor, op_ObserveAccessor, op_BitOr, op_BitXOr, op_BitAnd, punc_ParenthesisOpen, punc_ParenthesisClose, punc_BracketOpen, punc_BracketClose, punc_BraceOpen, punc_BraceClose, punc_Comma, punc_Dot, punc_Question, punc_Colon, punc_Semicolon, go_ref, go_acs, go_string, go_number, go_objectKey, type_Body, type_Statement, type_SymbolRef, type_FunctionRef, type_Accessor, type_AccessorExpr, type_Value, type_Object, type_Array, type_UnaryPrefix, type_Ternary, state_body, state_arguments, PRECEDENCE, Ast_Body, Ast_Statement, Ast_Value, Ast_Array, Ast_Object, Ast_FunctionRef, Ast_SymbolRef, Ast_Accessor, Ast_AccessorExpr, Ast_UnaryPrefix, Ast_TernaryStatement, ast_remove, ast_findPrev, ast_handlePrecedence, util_throw, util_getNodeStack, util_resolveRef, util_resolveRefValue, util_resolveAcc, __rgxEscapedChar, Ast_FunctionRefUtil, op_Minus, op_Plus, op_Divide, op_Multip, op_Modulo, op_LogicalOr, op_NullishCoalescing, op_LogicalAnd, op_LogicalNot, op_LogicalEqual, op_LogicalEqual_Strict, op_LogicalNotEqual, op_LogicalNotEqual_Strict, op_LogicalGreater, op_LogicalGreaterEqual, op_LogicalLess, op_LogicalLessEqual, op_AsyncAccessor, op_ObserveAccessor, op_BitOr, op_BitXOr, op_BitAnd, punc_ParenthesisOpen, punc_ParenthesisClose, punc_BracketOpen, punc_BracketClose, punc_BraceOpen, punc_BraceClose, punc_Comma, punc_Dot, punc_Question, punc_Colon, punc_Semicolon, go_ref, go_acs, go_string, go_number, go_objectKey, type_Body, type_Statement, type_SymbolRef, type_FunctionRef, type_Accessor, type_AccessorExpr, type_Value, type_Object, type_Array, type_UnaryPrefix, type_Ternary, state_body, state_arguments, PRECEDENCE, util_throw, util_getNodeStack, util_resolveRef, util_resolveRefValue, util_resolveAcc, Ast_FunctionRefUtil, _evaluateAstDeferred, _evaluateAstDeferredInner, SubjectKind, DeferredExp, getDeferrables, ObjectStream, PromisedStream, SubjectStream, Subscription, PromisedStream, AwaitableCtx, obj_addObserver, obj_removeObserver, expression_bind, expression_unbind, expression_callFn, expression_createBinder, PromisedStream, obj_addObserver, obj_hasObserver, obj_removeObserver, obj_lockObservers, obj_unlockObservers, obj_addMutatorObserver, obj_removeMutatorObserver, expression_bind, expression_unbind, expression_callFn, expression_createBinder, expression_createListener, arr_remove, arr_each, arr_contains, arr_pushMany, prop_OBS, prop_MUTATORS, prop_TIMEOUT, prop_DIRTY, prop_PROXY, obj_defineProp, obj_ensureFieldDeep, obj_ensureObserversProperty, obj_getObserversProperty, obj_ensureRebindersProperty, obj_chainToProp, objMutator_addObserver, objMutator_removeObserver, getSelfMutators, obj_defineCrumbs, obj_sub_notifyListeners, obj_deep_notifyListeners, obj_callMethod, expr_getHost, Ast_Body, Ast_Statement, Ast_Value, Ast_Array, Ast_Object, Ast_FunctionRef, Ast_SymbolRef, Ast_Accessor, Ast_AccessorExpr, Ast_UnaryPrefix, Ast_TernaryStatement, op_Minus, op_Plus, op_Divide, op_Multip, op_Modulo, op_LogicalOr, op_NullishCoalescing, op_LogicalAnd, op_LogicalNot, op_LogicalEqual, op_LogicalEqual_Strict, op_LogicalNotEqual, op_LogicalNotEqual_Strict, op_LogicalGreater, op_LogicalGreaterEqual, op_LogicalLess, op_LogicalLessEqual, op_AsyncAccessor, op_ObserveAccessor, op_BitOr, op_BitXOr, op_BitAnd, punc_ParenthesisOpen, punc_ParenthesisClose, punc_BracketOpen, punc_BracketClose, punc_BraceOpen, punc_BraceClose, punc_Comma, punc_Dot, punc_Question, punc_Colon, punc_Semicolon, go_ref, go_acs, go_string, go_number, go_objectKey, type_Body, type_Statement, type_SymbolRef, type_FunctionRef, type_Accessor, type_AccessorExpr, type_Value, type_Object, type_Array, type_UnaryPrefix, type_Ternary, state_body, state_arguments, PRECEDENCE, coll_each, coll_indexOf, coll_remove, coll_map, coll_find, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, env_class_overrideArgs, env_class_wrapCtors, arr_remove, arr_each, arr_contains, arr_pushMany, compo_addChild, compo_addChildren, compo_renderElements, compo_emitInserted, coll_each, coll_indexOf, coll_remove, coll_map, coll_find, __rgxEscapedChar, __rgxEscapedChar, arr_remove, arr_each, arr_contains, arr_pushMany, coll_each, coll_indexOf, coll_remove, coll_map, coll_find, coll_each, coll_indexOf, coll_remove, coll_map, coll_find, arr_remove, arr_each, arr_contains, arr_pushMany, coll_each, coll_indexOf, coll_remove, coll_map, coll_find, arr_remove, arr_each, arr_contains, arr_pushMany, arr_remove, arr_each, arr_contains, arr_pushMany, attr_first, attr_first, Methods, defMethods_getSource, defMethods_compile, nodeMethod_getSource, nodeMethod_compile, sourceUrl_get, _args_toCode, scopeRefs_getImportVars, sourceUrl_get, _args_toCode, scopeRefs_getImportVars, env_class_overrideArgs, env_class_wrapCtors, Define, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, Methods, coll_each, coll_indexOf, coll_remove, coll_map, coll_find, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, Define, ModuleMidd, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, coll_each, coll_indexOf, coll_remove, coll_map, coll_find, compo_addChild, compo_addChildren, compo_renderElements, compo_emitInserted, arr_remove, arr_each, arr_contains, arr_pushMany, arr_remove, arr_each, arr_contains, arr_pushMany, obj_addObserver, obj_removeObserver, expression_bind, expression_unbind, expression_callFn, expression_createBinder, expr_getHost, coll_each, coll_indexOf, coll_remove, coll_map, coll_find, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, customTag_get, customTag_getAll, customTag_register, customTag_registerFromTemplate, customTag_registerScoped, customTag_define, customTag_registerResolver, customTag_Compo_getHandler, customTag_Base, customTag_Resolver, compo_addChild, compo_addChildren, compo_renderElements, compo_emitInserted, arr_remove, arr_each, arr_contains, arr_pushMany, _evaluateAstDeferred, _evaluateAstDeferredInner, obj_addObserver, obj_hasObserver, obj_removeObserver, obj_lockObservers, obj_unlockObservers, obj_addMutatorObserver, obj_removeMutatorObserver, expr_getHost, _parseCached, _parse, _evaluate, _evaluateAst, arr_remove, arr_each, arr_contains, arr_pushMany, compo_addChild, compo_addChildren, compo_renderElements, compo_emitInserted, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, compo_addChild, compo_addChildren, compo_renderElements, compo_emitInserted, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, compo_addChild, compo_addChildren, compo_renderElements, compo_emitInserted, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern, fn_proxy, fn_apply, fn_doNothing, fn_createByPattern;
  ...
  (function() {
    ...
    class_Dfr = /** @class */ function() {
      ...
      class_Dfr.prototype.then = function(done_, fail_) {
  ...
  (function() {
    ...
    obj_hasProperty = function(obj, x) {
      x = obj_getProperty(obj, x);
      return void 0 !== x;
    };
    ...
    /**
      ...
      if (is_Object(json)) {
        for (var key in json) {
          ...
          if (opts.removeEmptyArrays && is_ArrayLike(val) && 0 === val.length) {
            delete json[key];
          }
        }
        return json;
    ...
    function isDefault(x, opts) {
      ...
      if (opts.removeEmptyArrays && is_ArrayLike(x) && 0 === x.length) {
        return true;
      }
      return false;
    }
  ...
  (function() {
    error_createClass = function(name, Proto, Ctor) {
      Ctor = _createCtor(Proto, Ctor);
    ...
    error_formatSource = function(lineNum, rowNum, filename) {
      var str = error_cursor(lineNum, rowNum), lines = str[0], lineNum = str[1], rowNum = str[2], str = '';
      if (null != filename) {
    ...
    /**
      ...
      var row = str.substring(0, index).split('\n'), line = row.length, row = index + 1 - row.slice(0, line - 1).join('\n').length;
      if (line > 1) {
  ...
  (function() {
    var MaskWarn = 'undefined' === typeof console;
    var MaskError = Function.prototype.bind;
    log = MaskWarn ? fn_doNothing : MaskError.call(console.warn, console);
    log_warn = MaskWarn ? fn_doNothing : MaskError.call(console.warn, console, 'MaskJS [Warn] :');
    log_error = MaskWarn ? fn_doNothing : MaskError.call(console.error, console, 'MaskJS [Error] :');
    MaskWarn = 4;
    MaskError = error_createClass('MaskError', {}, MaskWarn);
    MaskWarn = error_createClass('MaskWarn', {}, MaskWarn);
    ...
    function delegate_parserReporter(Ctor, type) {
      return function(error, source, index, tokenMsg, stateMsg, cursorMsg) {
        error = new Ctor(error);
        tokenMsg = formatToken(tokenMsg);
        if (tokenMsg) {
          error.message += tokenMsg;
        }
        stateMsg = formatState(stateMsg);
        if (stateMsg) {
          error.message += stateMsg;
        }
        cursorMsg = error_formatSource(source, index, cursorMsg);
        if (cursorMsg) {
          error.message += '\n' + cursorMsg;
        }
        report(error, 'error');
    ...
    function delegate_withNode(Ctor, type) {
      return function(error, node) {
        error = error instanceof Error ? error : new Ctor(stringifyError(error));
        if (null != node) {
    ...
    function report(error, stack) {
      if (listeners_emit(stack, error)) {
        return;
      }
      var fn = 'error' === stack ? log_error : log_warn;
      stack = error.stack || '';
      fn(error.message + '\n' + stack);
    }
  ...
  var custom_optimize, custom_Utils, custom_Statements, custom_Attributes, custom_Tags, custom_Parsers, custom_Parsers_Transform, custom_Optimizers, customAttr_register, customAttr_get, customUtil_get, customUtil_$utils, customUtil_register, customTag_get, customTag_getAll, customTag_register, customTag_registerScoped, customTag_registerFromTemplate, customTag_registerResolver, customTag_Compo_getHandler, customTag_define, customTag_Base, customStatement_register, customStatement_get;
  (function() {
    ...
    (function() {
      ...
      function processParsedDelegate(fn) {
        return function(expr, model, ctx, el, ctr, type, args) {
          args = expression_evalStatements(expr, model, ctx, ctr, args);
    ...
    (function() {
      ...
      /**
			 ...
			 */;
      customTag_registerScoped = function(map, name, Handler) {
        if (null == map) {
          // Use global
        ...
        var obj = is_Function(map) ? map.prototype : map;
  ...
  var exp_type_Sync, exp_type_Async, exp_type_Observe, expression_getType, expression_eval, expression_evalStatements, expression_varRefs, expression_parse, ExpressionUtil;
  (function() {
    (function() {
      (function() {
        op_Minus = '-';
 ...
 // 16
      ...
      (function() {
        ...
        Ast_Statement = /** @class */ function() {
          ...
          Ast_Statement.prototype.toString = function() {
            var _b;
            return null !== (_b = null === (_b = this.body) || void 0 === _b ? void 0 : _b.toString()) && void 0 !== _b ? _b : '';
          };
      ...
      (function() {
        ...
        util_resolveRefValue = function(astRef, model, this_, ctr, preResults) {
      ...
      _parseCached = function(mix, _a, node) {
        if (null == mix) {
          return null;
        }
        if ('string' === typeof mix) {
          var node_ = node;
          if (null == node_ && null != _a) {
            var x = _a;
          ...
          return null !== (_a = cache[mix]) && void 0 !== _a ? _a : cache[mix] = _parse(mix, false, node_);
        }
        return mix;
      };
      var index = 0;
      ...
      _parse = function(expr, earlyExit, node) {
        ...
        outer: while (true) {
          ...
          switch (directive) {
           ...
           case go_ref:
           case go_acs:
            var key = index, ref = parser_getRef();
            if (directive === go_ref) {
              if ('null' === ref) {
                ref = null;
              }
            ...
            if (40 === c) {
              ...
              index++;
              var Ctor = new Ast_FunctionRef(current, ref);
              if (directive === go_acs && current.type === type_Statement) {
                current.next = Ctor;
              } else {
                ast_append(current, Ctor);
              }
              current = Ctor.newArg();
              continue;
            }
            Ctor = directive === go_ref ? Ast_SymbolRef : Ast_Accessor;
            current = ast_append(current, new Ctor(current, ref));
            current.sourceIndex = key;
            break;
      ...
      function parser_getString(string) {
        var nindex, isEscaped = false, _char = 39 === string ? '\'' : '"', string = index;
        ...
        string = template.substring(string, index);
        if (true === isEscaped) {
      ...
      function parser_getNumber() {
        ...
        str = template.substring(str, index);
        if (isBigInt) {
          // skip 'n'
          index++;
          return BigInt(str);
    ...
    (function() {
      (function() {
          ...
          (function() {
            (function() {
              ...
              SubjectStream = /** @class */ function() {
                ...
                SubjectStream.prototype.fromStream = function(_a, inner) {
                  this._pipe = _a;
                  this._inner = inner;
                  if (0 !== this._cbs.length) {
                    this._pipeSub = _a.subscribe(this.next, this.error);
                  }
                  if (void 0 === this.value && null != _a.value) {
                    this.value = _a.value;
                  }
                  this._innerSub = null === (_a = this._inner) || void 0 === _a ? void 0 : _a.subscribe(this.onInnerChanged);
                };
                ...
                SubjectStream.prototype.unsubscribe = function(cb) {
                  ...
                  if (null != this._pipe && 0 === this._cbs.length) {
                    null === (_c = (_d = this._pipe).unsubscribe) || void 0 === _c ? void 0 : _c.call(_d, this.next);
                    null === (_d = null === (_c = this._innerSub) || void 0 === _c ? void 0 : _c.unsubscribe) || void 0 === _d ? void 0 : _d.call(_c, this.onInnerChanged);
                    return;
                  }
                };
                ...
                SubjectStream.prototype.call = function(index, x) {
                  for (var i = 0; i < this._cbs.length; i++) {
                    var opts = this._cbs[i];
                    var fn = opts[index];
                    opts = opts[2];
                    if (true === (null === opts || void 0 === opts ? void 0 : opts.once)) {
                      this._cbs.splice(i, 1);
                    }
                    fn(x);
                  }
            ...
            PromisedStream = /** @class */ function(_super) {
              ...
              PromisedStream.prototype.then = function(onSuccess, onError) {
                ...
                var opts = this.kind === SubjectKind.Stream ? null : OPTS_ONCE;
        ...
        (function() {
          (function() {
            (function() {
              (function() {
                ...
                obj_ensureObserversProperty = function(arr, prop) {
                  var obs = arr[prop_OBS];
                  if (null == obs) {
                    obs = {
                      __dirty: null,
                      __dfrTimeout: null,
                ...
                obj_getObserversProperty = function(obs, type) {
                  obs = obs[prop_OBS];
              ...
              (function() {
                objMutator_addObserver = function(obj, obs, cb) {
                  var methods = obs.methods, throttle = obs.throttle, obs = obj_ensureObserversProperty(obj, prop_MUTATORS);
                  if (0 === obs.length) {
                ...
                objMutator_removeObserver = function(obs, mutators, cb) {
                  obs = obj_getObserversProperty(obs, prop_MUTATORS);
                  if (null == obs) {
                    return;
                  }
                  if (void 0 === cb) {
                ...
                function call(obj, result, method, args) {
                  var cbs = obj_ensureObserversProperty(obj, prop_MUTATORS), result = result.apply(obj, args);
              ...
              (function() {
                ...
                function obj_defineCrumb(path, obj, key, rebinder) {
                  var hash = obj[prop_OBS] && obj[prop_OBS][key];
                  if (null != hash) {
                    return;
                  }
                  var old, value = obj[key];
                  hash = obj_ensureRebindersProperty(obj);
                  var set = hash[key];
                  if (null != set) {
                    if (null == set[path]) {
                      set[path] = rebinder;
              ...
              (function(AddObserver) {
                function add(val, mutators, cb) {
                  if (null == val) {
                    log_error('Not possible to add the observer for "' + mutators + '" as the model is undefined.');
                    return;
                  }
                  // closest observer
                  var parts = mutators.split('.'), i = -1;
                  if (pushClosest(val[parts[0]], parts, 1, cb)) {
                    /* We have added a callback as close as possible to the observle property owner
							             ...
							             */
                    var cbs_1 = pushListener_(val, mutators, cb);
                    if (1 === cbs_1.length) {
                      var cbs = parts.splice(0, i);
                      if (0 !== cbs.length) {
                        attachProxy_(val, mutators, cbs_1, cbs);
                      }
                    }
                    if (parts.length > 1) {
                      obj_defineCrumbs(val, parts);
                    }
                    return;
                  }
                  cbs = pushListener_(val, mutators, cb);
                  if (1 === cbs.length) {
                    attachProxy_(val, mutators, cbs, parts);
                  }
                  val = obj_getProperty(val, mutators), mutators = getSelfMutators(val);
                  if (null != mutators) {
                    objMutator_addObserver(val, mutators, cb);
                  }
                }
                AddObserver.add = add;
                function pushClosest(ctx, prop, mutators, cb) {
                  if (null == ctx) {
                    return false;
                  }
                  if (mutators < prop.length - 1 && pushClosest(ctx[prop[mutators]], prop, mutators + 1, cb)) {
                    return true;
                  }
                  var x = ctx[prop_OBS];
                  if (null == x) {
                  ...
                  prop = obj_chainToProp(prop, mutators);
                  mutators = x[prop];
                  if (null == mutators) {
                    // fix [obj.test](hosts)
                    mutators = x[prop_PROXY];
                    if (null != mutators && true === mutators[prop]) {
                      pushListener_(ctx, prop, cb);
                      x = obj_getProperty(ctx, prop);
              ...
              obj_hasObserver = function(obs, property, callback) {
                // nested observer
                var parts = property.split('.'), imax = parts.length, i = -1, x = obs;
                while (++i < imax) {
                  x = x[parts[i]];
                  if (null == x) {
                    break;
              ...
              obj_removeObserver = function(val, mutators, callback) {
                if (null == val) {
                  log_error('Not possible to remove the observer for "' + mutators + '" as current model is undefined.');
                  return;
                }
                // nested observer
                var parts = mutators.split('.'), imax = parts.length, i = -1, x = val;
                while (++i < imax) {
                  x = x[parts[i]];
                  if (null == x) {
                    break;
                ...
                var obs = obj_getObserversProperty(val, mutators);
                if (null != obs) {
                  if (void 0 === callback) {
              ...
              function attachProxy_(obj, property, cbs, chain) {
                ...
                var parent = key > 1 ? obj_ensureFieldDeep(obj, chain) : obj;
                key = chain[key - 1];
                var currentVal = parent[key];
                if ('length' === key) {
                  var hash = getSelfMutators(parent);
                  if (null != hash) {
                    objMutator_addObserver(parent, hash, function() {
                ...
                hash = obj_ensureObserversProperty(parent);
                hash = hash[prop_PROXY];
                if (true === hash[key]) {
                  return;
                }
                hash[key] = true;
              ...
              function pushListener_(obj, obs, cb) {
                obs = obj_ensureObserversProperty(obj, obs);
            ...
            (function() {
              ...
              (function() {
                // [ObjectHost, Property]
                var tuple = [ null, null ];
                expr_getHost = function(accessor, model, result, ctr) {
                  result = get(accessor, model, result, ctr);
                ...
                function get(scope, model, ctx, ctr) {
                  if (null == scope) {
                    return;
                  }
                  if ('object' === typeof scope) {
                    var owner = expression_eval(scope.accessor, model, null, ctr);
                    if (null == owner || 'object' !== typeof owner) {
                      return null;
                    }
                    tuple[0] = owner;
                    tuple[1] = scope.ref;
                  ...
                  var property = scope, parts = property.split('.'), owner = parts.length;
                  if (owner > 1) {
                    scope = parts[0];
                    if ('this' === scope || '$c' === scope || '$' === scope) {
                      // Controller Observer
                      owner = _getObservable_Controller(ctr, parts[1]);
                      var obj = scope.length + 1;
                      tuple[0] = owner;
                      tuple[1] = property.substring(obj);
                      return tuple;
                    }
                    if ('$scope' === scope) {
                      // Controller Observer
                      scope = _getObservable_Scope(ctr, parts[1]);
                      obj = 7;
                      tuple[0] = scope;
                      tuple[1] = property.substring(obj);
                      return tuple;
              ...
              expression_bind = function(expr, model, obs, ctr, cb, type) {
                if ('.' === expr) {
                  if (null != model) {
                ...
                if (true !== (null === type || void 0 === type ? void 0 : type.propertiesOnly)) {
                  type = expression_getType(expr);
                  if (type === exp_type_Observe) {
                    obs = _evaluateAstDeferredInner(expr, model, obs, ctr);
                    if (null === obs || void 0 === obs ? void 0 : obs.subscribe) {
              ...
              function toggleExpressionsBindings(toggleFn, mix, model, ctr, cb) {
                mix = expression_varRefs(mix, model, null, ctr);
                if (null == mix) {
                  return null;
                }
                if ('string' === typeof mix) {
              ...
              expression_callFn = function(accessor, model, path, obj, args) {
                path = expr_getHost(accessor, model, path, obj);
                if (null != path) {
                  obj = path[0], path = path[1];
              ...
              function _toggleObserver(mutatorFn, property, obj, accessor, callback) {
                property = expr_getHost(accessor, property, null, obj);
                if (null == property) {
                  return;
                }
                obj = property[0], property = property[1];
                if (null == obj) {
                  return;
                }
          ...
          ObjectStream = /** @class */ function(_super) {
            ...
            ObjectStream.prototype.unsubscribe = function(_a) {
              _super.prototype.unsubscribe.call(this, _a);
              null === (_a = this.dispose) || void 0 === _a ? void 0 : _a.unsubscribe();
              this.dispose = null;
        ...
        _evaluateAstDeferred = function(ast, model, ctx, x) {
          x = _evaluateAstDeferredInner(ast, model, ctx, x);
      ...
      _evaluate = function(mix, model, ctx, ctr, ast) {
        if ('.' === mix) {
          return model;
        }
        ast = _parseCached(mix, ctr, ast);
        if (null == ast) {
          return null;
        }
    ...
    (function() {
      /**
			 ...
			 */
      refs_extractVars = function(ast, model, ctx, ctr) {
        ast = 'string' === typeof ast ? _parseCached(ast) : ast;
      ...
      function _extractVars(expr, model, ctx, ctr) {
        ...
        if (type_SymbolRef === exprType || type_Accessor === exprType || type_AccessorExpr === exprType) {
          ...
          while (null != next) {
            prop = next.type;
            if (type_FunctionRef === prop) {
              return _extractVars(next, model, ctx, ctr);
            }
            if (type_SymbolRef !== prop && type_Accessor !== prop && type_AccessorExpr !== prop) {
              log_error('Ast Exception: next should be a symbol/function ref');
              return null;
            }
            var prop = prop === type_AccessorExpr ? _evaluateAst(next.body, model, ctx, ctr) : next.body;
    ...
    exp_type_Async = 2;
    exp_type_Observe = 3;
    expression_getType = function(ast) {
      ast = 'string' === typeof ast ? _parse(ast) : ast;
      if (null != ast) {
        if (ast.observe) {
    ...
    customUtil_register('expression', function(value, model, ctx, element, owner, name, type, node) {
      owner = 'compo-attr' === type || 'compo-prop' === type ? owner.parent : owner;
  ...
  (function() {
    ...
    (function() {
      (function() {
        ...
        function _attr_setProperties_Delegate(hash) {
          return function(compo, attr, model, container) {
            for (var key in hash) {
              var error = hash[key];
              var val = attr[key];
              error = error(compo, key, val, model, container, attr);
              if (null == error) {
                continue;
              }
        ...
        function _attr_setProperty_Delegate(Proto, metaKey, metaVal, type, 
        /*out*/ hash) {
          var optional = 63 === metaKey.charCodeAt(0), // ?
          default_ = null, attrName = optional ? metaKey.substring(1) : metaKey;
          var property = type ? _getProperty(attrName, metaVal) : attrName;
          var fn = null;
          type = typeof metaVal;
          if ('string' === type) {
          ...
          Proto[property] = null;
          Proto = null;
          hash[attrName] = function(compo, val, attrVal, model, container, attr) {
            if (null == attrVal) {
              if (false === optional) {
                return Error('Expected attribute ' + val);
              }
              if (null != factory_) {
            ...
            val = fn.call(compo, attrVal, model, container, val);
        ...
        function _getProperty(prop, attrDef) {
        ...
        var _ensureFns_Delegate = {
          ...
          options: function(opts) {
            ...
            return function(x, model, container, attrName) {
              ...
              if (null != type) {
                var error = _ensureFns[type];
                if (null != error) {
                  x = error.apply(this, arguments);
              ...
              if (null != validate) {
                error = validate.call(this, x, model, container);
                if (error) {
                  return Error(error);
                }
              }
        ...
        compo_meta_prepairArgumentsHandler = function(meta) {
          meta = getMetaProp_(meta);
      ...
      (function() {
        ...
        Anchor = {
          ...
          resolveCompo: function(el, silent) {
            ...
            var ownerId;
            do {
              var compo = el.getAttribute('x-compo-id');
              if (null != compo) {
                if (null == ownerId) {
                  ownerId = compo;
                }
      ...
      (function() {
        (function() {
          ...
          coll_remove = function(coll, i) {
            i = coll_indexOf(coll, i);
            if (-1 === i) {
              return false;
            }
            coll.splice(i, 1);
        ...
        compo_detachChild = function(childCompo) {
          ...
          removed = coll_remove(removed, childCompo);
          if (false === removed) {
        ...
        compo_errored = function(compo, desc) {
          var msg = '[%] Failed.'.replace('%', compo.compoName || compo.tagName);
          if (desc) {
            desc = desc.message || desc.statusText || String(desc);
            if (desc) {
              msg += ' ' + desc;
            }
          }
        ...
        function getTemplateProp_(node) {
      ...
      (function() {
        ...
        (function() {
          ...
          IComb.create = function(comb, type, fn, ctx) {
            var codes = IComb.parse(comb);
            comb = Key.create(codes);
            if (null == comb) {
        ...
        (function() {
          ...
          KeySequance = class_create(IComb, {
            index: 0,
            tryCall: function(event, codes, matched) {
              matched = this.check_(codes, matched);
            ...
            check_: function(codes, lastCode) {
              var last = this.set[this.index], keys = last.keys, last = last.last;
              var l = codes.length;
              if (l < keys.length) {
        ...
        (function() {
          ...
          event_getCode = function(code) {
            code = code.keyCode || code.which;
            if (code >= 96 && code <= 105) {
              // numpad digits
              return code - 48;
            }
        ...
        (function() {
          ...
          CombHandler.prototype = {
            ...
            emit_: function(type, event, lastCode) {
              var stat, combs = this.combs, imax = combs.length, i = 0;
              for (;i < imax; i++) {
                stat = combs[i];
                if (stat.type !== type) {
                  continue;
                }
                stat = stat.tryCall(event, this.keys, lastCode);
        ...
        (function() {
          Hotkey = {
            on: function(combDef, fn, comb) {
              if (null == handler) {
                init();
              }
              comb = IComb.create(combDef, 'keydown', fn, comb);
              handler.attach(comb);
            },
            off: function(fn) {
              handler.off(fn);
        ...
        KeyboardHandler = {
          ...
          on: function(el, handler, def, fn) {
            if ('keypress' === handler || 'press' === handler) {
              handler = 'keydown';
            }
            var comb = IComb.create(def, handler, fn);
            if (comb instanceof Key) {
              event_bind(el, handler, function(event) {
                var r = event_getCode(event);
                r = comb.tryCall(event, null, r);
                if (r === Key_MATCH_OK) {
                  event.preventDefault();
                }
              });
          ...
          attach: function(el, type, comb, fn, hotkeys) {
      ...
      (function() {
        (function() {
          ...
          _fire = function(ctr, slot, sender, isDisabled, direction) {
            if (null == ctr) {
              return false;
            }
            var found = false;
            var args = isDisabled;
            var result = null != ctr.slots && ctr.slots[slot];
            if ('string' === typeof result) {
              result = ctr[result];
            }
            if ('function' === typeof result) {
              found = true;
              isDisabled = null === (isDisabled = ctr.slots.__disabled) || void 0 === isDisabled ? void 0 : isDisabled[slot];
              if (true !== isDisabled) {
                result = null == args ? result.call(ctr, sender) : result.apply(ctr, __spreadArrays([ sender ], args));
                if (false === result) {
                  return true;
                }
        ...
        (function() {
          ...
          function __toggle_slotState(disabled, slot, isActive) {
            var slots = disabled.slots;
        ...
        (function() {
          ...
          var SlotExpression = /** @class */ function() {
            ...
            SlotExpression.prototype.call = function(state) {
              var slot = this.findSlot(state);
              if ('^' !== slot.action) {
                this.flags[state] = 1;
                state = expression_eval(this.expression, this.flags);
                if (state) {
                  this.cb();
                }
                return;
        ...
        (function() {
          (function() {
            (function() {
              ...
              event_trigger = function(el, event) {
            ...
            node_tryDispose = function(node) {
              if (node.hasAttribute('x-compo-id')) {
                var i = node.getAttribute('x-compo-id'), compo = Anchor.getByID(i);
                if (null != compo) {
                  ...
                  i = _Array_indexOf.call(compo.$, node);
                  if (-1 !== i) {
          ...
          function _create(name, asEvent) {
            customAttr_register('x-' + name, 'client', function(isSlot, attrValue, model, ctx, el, ctr) {
              isSlot = isSlot === ctr;
              _attachListener(el, ctr, attrValue, asEvent, isSlot);
            });
          }
          function _attachListener(el, ctr, definition, asEvent, isSlot) {
            var attr = -1 !== definition.indexOf(';');
            var signals = '';
            var arr = attr ? definition.split(';') : null;
            var count = attr ? arr.length : 1;
          ...
          function _handleDefinition(el, ctr, definition, asEvent, isSlot) {
            var fn = rgx_DEF.exec(definition);
            if (null == fn) {
              log_error('Signal definition is not resolved ' + definition + '. The pattern is: (source((sourceArg))?:)?signal((expression))?');
              return null;
            }
            var source = fn[2], sourceArg = fn[4], signal = fn[5], fn = fn[7];
            if (null != asEvent) {
              sourceArg = source;
              source = asEvent;
            }
            fn = _createListener(ctr, signal, fn);
            if (!source) {
        ...
        CompoSignals = {
          signal: {
            toggle: _toggle_all,
            // to parent
            emitOut: function(ctr, slot, sender, captured) {
              captured = _fire(ctr, slot, sender, captured, -1);
              // if DEBUG
      ...
      (function() {
        ...
        (function() {
          ...
          (function() {
            Tween = /** @class */ function() {
              ...
              Tween.prototype.tick = function(x, parent) {
                if (null == this.startedAt) {
                  this.startedAt = x;
                }
                var d = x - this.startedAt;
                x = this.timing(d, this.start, this.diff, this.duration);
                if (d >= this.duration) {
            ...
            /*2ms;3s*/            function _toMs(str, d) {
              if (null == str) {
                log_error('Easing: Invalid duration in ' + d);
                return 0;
              }
              d = parseFloat(str);
              if (str.indexOf('ms') > -1) {
        ...
        ani_updateAttr = function(start, key, prop, end, tweens) {
          var transition = start.attr[key + '-transition'];
          if (null == transition && is_Object(tweens)) {
            transition = tweens.transition;
          }
          if (null == transition) {
            start.attr[key] = end;
            if (null != prop) {
          ...
          tweens = start.__tweens;
          if (null == tweens) {
            tweens = start.__tweens = new TweenManager(start);
          }
          start = start[prop];
          end;
      ...
      (function() {
        ...
        selector_match = function(obj, selector, type) {
          if (null == obj) {
            return false;
          }
          if (is_String(selector)) {
            if (null == type) {
              type = Dom[obj.compoName ? 'CONTROLLER' : 'SET'];
            }
            selector = selector_parse(selector, type);
          }
          obj = selector.prop ? obj[selector.prop] : obj;
          if (null == obj) {
            return false;
          }
      ...
      (function() {
        (function() {
            ...
            domLib_initialize = function() {
              ...
              (function() {
                ...
                [ 'appendMask', 'prependMask', 'beforeMask', 'afterMask' ].forEach(function(method, index) {
                  domLib.fn[method] = function(template, model, self, ctx) {
                    if (0 === this.length) {
                      return this;
                    }
                    if (this.length > 1) {}
                    if (null == self) {
                      self = index < 2 ? this.compo() : this.parent().compo();
                    }
                    var isUnsafe = false;
                    if (null == self) {
                      self = {};
                    ...
                    var compos = self.components, i = compos.length, self = renderer_render(template, model, ctx, null, self);
                    var self = this[jQ_Methods[index]](self), imax = compos.length;
                    for (;i < imax; i++) {
          ...
          CompoConfig = {
            selectors: {
              $: function(compo, r) {
                r = domLib_find(compo.$, r);
                return r;
              },
              compo: function(compo, r) {
                r = compo_find(compo, r);
                return r;
              }
            },
            /**
        ...
        Children_ = {
          ...
          select: function(component, compos) {
            for (var element in compos) {
              var engine = compos[element], events = null, selector = null;
              if (engine instanceof Array) {
                console.error('obsolete');
                selector = engine[0];
                events = engine.splice(1);
              }
              if ('string' === typeof engine) {
                selector = engine;
              }
              if (null == engine || null == selector) {
                log_error('Unknown component child', element, compos[element]);
                log_warn('Is this object shared within multiple compo classes? Define it in constructor!');
                return;
              }
              var index = selector.indexOf(':');
              engine = CompoConfig.selectors[selector.substring(0, index)];
              if (null == engine) {
                var $els = component.$;
                var el = void 0;
                ...
                component.compos[element] = el;
              } else {
                selector = selector.substring(++index).trim();
                component.compos[element] = engine(component, selector);
              }
              element = component.compos[element];
              if (null != events) {
                if (null != element.$) {
                  element = element.$;
                }
      ...
      CompoProto = {
        ...
        getAttribute: function(key) {
          var prop = null === (prop = this.meta.attributes) || void 0 === prop ? void 0 : prop[key];
          if (null == prop) {
            return this.attr[key];
          }
          prop = compo_meta_toAttributeKey(key, prop);
          return this[prop];
        },
        setAttribute: function(key, val) {
          var _b;
          var prop = null;
          var def = null === (_b = this.meta.attributes) || void 0 === _b ? void 0 : _b[key];
          if (null != def) {
        ...
        onEnterFrame: null,
        render: null,
        renderStart: function(model, ctx, x) {
          compo_ensureTemplate(this);
          if (is_Function(this.onRenderStart)) {
            x = this.onRenderStart(model, ctx, x);
            if (void 0 !== x && dfr_isBusy(x)) {
              compo_prepairAsync(x, this, ctx);
            }
          }
        },
        renderStartClient: function(model, ctx, x) {
          if (is_Function(this.onRenderStartClient)) {
            x = this.onRenderStartClient(model, ctx, x);
            if (void 0 !== x && dfr_isBusy(x)) {
              compo_prepairAsync(x, this, ctx);
            }
          }
        ...
        append: function(template, frag, selector) {
          if (null == this.$) {
          ...
          frag = renderer_render(template, frag, null, null, this);
        ...
        (function() {
          ...
          customAttr_register('x-pipe-signal', 'client', function(node, attrValue, model, ctx, element, ctr) {
            ...
            while (++i < imax) {
              ...
              var pipe, signal = pipe.indexOf(':'), event = pipe.substring(0, signal), handler = pipe.substring(signal + 1).trim(), signal = handler.indexOf('.');
              if (-1 === signal) {
                log_error('Pipe-slot is invalid: {0} Usage e.g. "click: pipeName.pipeSignal"', pipe);
                return;
              }
              pipe = handler.substring(0, signal);
              signal = handler.substring(++signal);
              // if DEBUG
      ...
      (function() {
        (function() {
          (function(document) {
            ...
            (function() {
              ...
              function after_(parent, next, el) {
                next = null != next ? next.nextSibling : null;
            ...
            (function() {
              ...
              each([ 'add', 'remove', 'toggle' ], function(method) {
                var mutatorFn = false === isClassListSupported ? Shim[method] : function(classList, klass) {
        ...
        (function() {
          (function() {
            ...
            function newCaller(fn, self, x) {
              x = new (fn.bind.apply(fn, [ null ].concat(x)))();
              obj_extend(self, x);
            }
          })();
          var protos = [];
          ...
          compo_createExt = function(Proto, Extends) {
            ...
            var meta = Proto.hasOwnProperty('constructor') ? Proto.constructor : null;
            ...
            var Ctor = env_class_wrapCtors(Base, beforeFn, meta, classes);
            ...
            // do we need this?
            meta = _resolve_External('include');
            if (null != meta) {
              Proto.__resource = meta.url;
            }
            compo_prepairProperties(Proto);
            meta = Proto.meta;
            if (null == meta) {
          ...
          function inheritMiddProto_(Proto, BaseProto, source, inheritMethods) {
            for (var key in source) {
              ...
              type = mergeProperty(Proto, key, targetVal, type, inheritMethods);
              if ('function' === type) {
                Proto.super = null;
              }
            }
          ...
          function inheritBase_(Proto, BaseProto, inheritMethods) {
            for (var key in Proto) {
              ...
              type = mergeProperty(Proto, key, protoVal, type, inheritMethods);
              if ('function' === type) {
                Proto.super = null;
              }
            }
          ...
          function inheritInternals_(target, source, name) {
            ...
            for (var key in source) {
              ...
              if ('function' === type) {
                ...
                wrapperFn = wrapperFn ? wrapAutocallFn : wrapInheritedFn;
        ...
        CompoStatics = {
          ...
          initialize: function(mix, model, dom, container, instance) {
            if (null == mix) {
              throw Error('Undefined is not a component');
            }
            if (null == container) {
              if (dom && null != dom.nodeType) {
                container = dom;
                dom = null;
            ...
            if (null == instance && null != container) {
              instance = Anchor.resolveCompo(container);
            }
            if (null == instance) {
              instance = new Component();
            }
            dom = renderer_render(node, model, dom, null, instance), instance = instance.components[instance.components.length - 1];
            if (null != container) {
      ...
      (function() {
        ...
        deco_slot = function(mix) {
          return function(target, propertyKey, descriptor) {
            var slots = null !== (isPrivate = target.slots) && void 0 !== isPrivate ? isPrivate : target.slots = {};
            var name = 'string' === typeof mix ? mix : null === mix || void 0 === mix ? void 0 : mix.name;
            var isPrivate = 'string' !== typeof mix ? null !== (viaProperty = null === mix || void 0 === mix ? void 0 : mix.private) && void 0 !== viaProperty ? viaProperty : false : false;
        ...
        /** Tip: use constants instead string literals for arguments */        deco_pipe = function(pipeName, signalName) {
          return function(fn, propertyKey, descriptor) {
            var viaProperty = null !== (stream = fn.pipes) && void 0 !== stream ? stream : fn.pipes = {};
            var stream = null !== (stream = viaProperty[pipeName]) && void 0 !== stream ? stream : viaProperty[pipeName] = {};
            viaProperty = null == descriptor;
            fn = viaProperty ? fn[propertyKey] : descriptor.value;
            stream[null !== signalName && void 0 !== signalName ? signalName : propertyKey] = fn;
            return descriptor;
          };
        };
        /**
          ...
          return function(target, fn, descriptor) {
            var events = null !== (viaProperty = target.events) && void 0 !== viaProperty ? viaProperty : target.events = {};
            var viaProperty = null == descriptor;
            fn = viaProperty ? target[fn] : descriptor.value;
            events[selector] = fn;
            return descriptor;
          };
        };
        /**
          ...
          return function(target, fn, descriptor) {
            var hotkeys = null !== (viaProperty = target.hotkeys) && void 0 !== viaProperty ? viaProperty : target.hotkeys = {};
            var viaProperty = null == descriptor;
            fn = viaProperty ? target[fn] : descriptor.value;
            hotkeys[hotkey] = fn;
            return descriptor;
        ...
        deco_attr = function(opts) {
          return function(name, propertyKey, descriptor) {
            var attr = ensureMeta(name, 'attributes');
            name = null === opts || void 0 === opts ? void 0 : opts.name;
            if (null == name) {
 ...
 /*Array*/
      ...
      (function() {
        (function() {
          (function() {
            ...
            builder_setCompoModel = function(compo, model, ctx, argsModel) {
              var readModel = null != compo.meta && compo.meta.readArguments || null;
              argsModel = null == readModel ? null : readModel(compo.expression, model, ctx, argsModel);
              if (null != compo.model) {
            ...
            builder_setCompoProps = function(compo, node, model, ctx, container) {
              ...
              for (var key in props) {
                var x = props[key];
                x = is_Function(x) ? x('compo-prop', model, ctx, container, compo, key) : x;
          ...
          (function() {
            build_nodeFactory = function(config) {
              ...
              return function build_node(node, model, ctx, container, ctr, children) {
                ...
                if (null != children) {
                  ...
                  var props = ctr.ID;
                  if (null != props) {
                    el.setAttribute('x-compo-id', props);
                  }
                }
                ...
                props = node.attr;
                if (null != props) {
                  el_writeAttributes(el, node, props, model, ctx, container, ctr);
                }
                props = node.props;
                if (null != props) {
            ...
            function el_writeAttributes(el, node, attr, model, ctx, container, ctr) {
              for (var key in attr) {
                var fn = attr[key];
                var val = is_Function(fn) ? getValByFn('attr', fn, key, model, ctx, el, ctr) : fn;
                if (null == val) {
                  continue;
                }
            ...
            function el_writeProps(el, node, props, model, ctx, container, ctr) {
              for (var key in props) {
                ...
                // }
                var val = props[key], val = is_Function(val) ? getValByFn('prop', val, key, model, ctx, el, ctr) : val;
                if (null == val) {
                  continue;
                }
            ...
            function getValByFn(type, fn, result, model, ctx, el, ctr) {
              result = fn(type, model, ctx, el, ctr, result);
              if (null == result) {
                return null;
              }
              if ('string' === typeof result) {
          ...
          (function() {
            ...
            build_compoFactory = function(build, config) {
              ...
              return function build_compo(node, model, ctx, container, ctr, children) {
                var Handler, fn = node.tagName;
                if (null != node.controller) {
                  Handler = node.controller;
                }
                if (null == Handler) {
                  Handler = custom_Tags[fn];
                }
                if (null == Handler && builder_findAndRegisterCompo(ctr, fn)) {
                  Handler = custom_Tags[fn];
                }
                if (null == Handler) {
                  return build_NodeAsCompo(node, model, ctx, container, ctr, children);
                }
                var handler, fn = false;
                ...
                fn = fn ? build_Static : build_Component;
              ...
              function build_Component(compo, node, model_, ctx, container, ctr, children) {
                ...
                listeners_emit('compoCreated', compo, resume, ctx, container, node);
                var resume = builder_setCompoModel(compo, model_, ctx, ctr);
                if (is_Function(compo.renderStart)) {
                  compo.renderStart(resume, ctx, container);
                }
                compo_addChild(ctr, compo);
                if (true === compo.async) {
                  resume = builder_resumeDelegate(compo, resume, ctx, container, children, compo.renderEnd);
                  compo.await(resume);
                  return null;
                }
              ...
              function build_Static(compo, node, model, ctx, container, ctr, children) {
                var clone, i = compo.__Ctor, wasRendered = false;
                if (null != i) {
                  clone = new i(node, ctr);
                } else {
                  clone = compo;
                  for (var key in node) {
                    clone[key] = node[key];
                ...
                i = ctr.components.length - 1;
                if (is_Function(clone.render)) {
                  wasRendered = true;
                  compo = clone.render(model, ctx, container, ctr, children);
                  arr_pushMany(children, compo);
                  if (is_Function(clone.renderEnd)) {
                    compo = clone.renderEnd(compo, model, ctx, container, ctr);
                    if (null != compo) {
                      // overriden
              ...
              function build_NodeAsCompo(node, els, ctx, container, ctr, childs) {
          ...
          (function() {
            build_textFactory = function(_a) {
              var document = null !== (_a = null === _a || void 0 === _a ? void 0 : _a.document) && void 0 !== _a ? _a : BuilderData.document;
          ...
          /**
            ...
            function build(node, children, ctx, _a, tagName, container) {
              if (null == node) {
                return _a;
              }
              var elements, model = children, children = container, container = _a, _a = node.type;
              var ctr = tagName;
              if (null == ctr) {
              ...
              if (1 === _a && null != custom_Tags[tagName]) {
                // check if custom ctr exists
                _a = 4;
              }
              if (1 === _a && null != custom_Statements[tagName]) {
                // check if custom statement exists
                _a = 15;
              }
              if (null == container && 1 !== _a) {
              ...
              // Dom.STATEMENT
              if (15 === _a) {
                var nodes = custom_Statements[tagName];
                if (null == nodes) {
                ...
                if (15 === _a) {
                  ...
                  //     return container;
                  // }
                  nodes.render(node, model, ctx, container, ctr, children);
                  return container;
                }
              }
              // Dom.NODE
              ...
              if (4 === _a) {
                ...
                if (null == node.tagName) {
                  var attrHandlers = null === (_a = node.handlers) || void 0 === _a ? void 0 : _a.attr;
    ...
    (function() {
      ...
      function _resume(ctr, model, ctx, anchorEl, _a, finilize) {
        ...
        if (null != nodes) {
          ...
          builder_build(nodes, model, ctx, i, ctr, elements);
          anchorEl.parentNode.insertBefore(i, anchorEl);
        }
        if (null != _a && elements.length > 0) {
          var args = [ 0, 1 ].concat(elements);
          i = coll_indexOf(_a, anchorEl);
          if (i > -1) {
            args[0] = i;
            _a.splice.apply(_a, args);
          }
        ...
        // but only on a component, not a tag ctr
        if (null == ctr.tagName) {
          var attrHandlers = null === (_a = ctr.handlers) || void 0 === _a ? void 0 : _a.attr;
  ...
  (function() {
    ...
    /**
      ...
      var args = arguments, prop = args.length;
      if (0 === prop) {
        return __cfg;
      }
      if (1 === prop) {
  ...
  (function() {
    ...
    (function() {
      /**
			 ...
			 * @method parse
			 */
      parser_parse = function(template, nodes) {
        ...
        outer: while (true) {
          ...
          if (null != token) {
            if (state === state_attr) {
              ...
              var transform = custom_Parsers[token];
              if (null != transform) {
                // Parser should return: [ parsedNode, nextIndex, nextState ]
                var tuple = transform(template, index, length, current);
                var node = tuple[0], deco = tuple[2];
                index = tuple[1];
                state = 0 === deco ? go_tag : deco;
                if (null != node) {
                  node.sourceIndex = tokenIndex;
                  transform = custom_Parsers_Transform[token];
                  if (null != transform) {
                    var next = transform(current, node);
                    if (null != next) {
          ...
          if (state === go_tag) {
            ...
            if (91 /*[*/ === c) {
              ...
              deco = template.substring(start, index);
              deco = new Dom.DecoratorNode(deco, current);
        ...
        if (null != nodes && nodes !== fragment && true !== nodes.__single && null != current.nodes && 'imports' !== nodes.tagName) {
    ...
    (function() {
      ...
      (function() {
        obj_getPropertyEx = function(key, x, ctx, ctr) {
          if ('.' === key) {
            return x;
          }
          var props = key.split('.');
        ...
        function getFromScope_(ctr_, props, startIndex, imax) {
          ...
          while (null != ctr) {
            var x = ctr.scope;
            if (null != x) {
              x = getProperty_(x, props, startIndex, imax);
              if (void 0 !== x) {
                return x;
              }
            }
      ...
      function _char_isEscaped(str, c) {
        if (0 === c) {
          return false;
        }
        c = str.charCodeAt(--c);
      ...
      function _slice(string, str, i) {
        str = string.substring(str, i);
        i = str.indexOf(interp_START);
        if (-1 === i) {
          return str;
        }
        return _escape(str);
      ...
      InterpolationModel.prototype.process = function(model, ctx, el, ctr, name, type, node) {
        ...
        var util, expr = this.expr, fn = expr.indexOf(':');
        if (-1 !== fn) {
          if (0 === fn) {
            expr = expr.substring(fn + 1);
          } else {
      ...
      /**
        ...
        while (++i < imax) {
          if (true === even) {
            ...
            var mix = arr[i], mix = mix.process(model, ctx, el, ctr, name, type, node);
            if (null != mix) {
    ...
    (function() {
      ...
      /**
			 ...
			 * @memberOf mask
			 * @method parseHtml
			 */      parser_parseHtml = function(tripple) {
        tripple = parser_parseHtmlPartial(tripple, 0, false);
        return tripple[0];
      };
      parser_parseHtmlPartial = function(str, result, exitEarly) {
 ...
 // charCode
        ...
        outer: while (i <= imax) {
          ...
          if (state === state_attr) {
            ...
            i++;
            var maskFrag = current.tagName;
            if ('mask' === maskFrag || 1 === parser_cfg_ContentTags[maskFrag]) {
              var mix = HtmlTagExtract.getContent(str, i, maskFrag), txtContent = mix[0], mix = mix[1];
              i = mix;
              if ('mask' === maskFrag) {
                current.parent.nodes.pop();
                current = current.parent;
                mix = parser_parse(txtContent);
                if (mix.type !== Dom.FRAGMENT) {
                  maskFrag = new Dom.Fragment();
          ...
          if (60 === c) {
            ...
            if (33 /*!*/ === c) {
              ...
              if (str.substring(i + 1, i + 1 + DOCTYPE.length).toUpperCase() === DOCTYPE) {
                // DOCTYPE
                var content = new Dom.Node('!' + DOCTYPE, current);
                content.attr.html = 'html';
          ...
          token += str.substring(start, i);
          if ('' !== token) {
            content = parser_ensureTemplateFunction(token);
            current.appendChild(new Dom.TextNode(content, current));
          }
        }
        result = fragment.nodes;
        result = null != result && 1 === result.length ? result[0] : fragment;
      ...
      function tag_Open(next, current) {
        var node = current;
        var TAGS = IMPLIES_CLOSE[next];
        if (null != TAGS) {
          while (null != node && null != node.tagName && 1 === TAGS[node.tagName.toLowerCase()]) {
            node = node.parent;
          }
        }
        next = new Dom.Node(next, node);
      ...
      (function(HtmlTagExtract) {
        function getContent(str, i, match) {
          var start = i, end = i;
          match = rgxGet(match, i).exec(str);
          if (null == match) {
            end = i = str.length;
          } else {
            end = match.index;
    ...
    (function() {
      parser_parseLiteral = function(str, token, imax) {
        var i = cursor_skipWhitespace(str, token, imax);
        ...
        if (-1 === i) {
          parser_warn('Literal has no ending', str, token - 1);
          i = imax;
        }
        if (i === token) {
          ...
          if (nextC === c) {
            isUnescapedBlock = true;
            token = i + 2;
            i = str.indexOf(_char + _char + _char, token);
            if (-1 === i) {
              i = imax;
            }
          }
        }
        token = str.substring(token, i);
        if (true === isEscaped) {
          token = token.replace(__rgxEscapedChar[_char], _char);
        }
      ...
      (function() {
        ...
        (function() {
          ...
          token_Var = create('Var', {
            ...
            consume: function(str, i, end, out) {
              end = cursor_tokenEnd(str, i, end);
              if (end === i) {
                return i;
              }
          ...
          var Parsers = {
            flags: class_create({
              ...
              constructor: function(param, isOptional) {
                ...
                while (++i < imax) {
                  var l = parts[i], token = l.indexOf(':'), name = l.substring(0, token), l = l.substring(token + 1);
                  token = '|' + l + '|';
                  l = this.token.length;
          ...
          token_String = create('String', {
            ...
            consume: function(str, i, end, out) {
              var $var = str.charCodeAt(i);
              if (34 !== $var && 39 !== $var) {
                return i;
              }
              end = cursor_quoteEnd(str, i + 1, end, 34 === $var ? '"' : '\'');
          ...
          token_Group = create('Group', {
            ...
            consume: function(str, i, imax, end) {
              var start = cursor_skipWhitespace(str, i, imax);
              end = _consume(this.tokens, str, start, imax, end, this.optional);
        ...
        function compileArray(name, tokens, str, i, imax, optional) {
          ...
          var innerTokens = _compile(str, delimiter, i);
          i++;
          ...
          delimiter = str.substring(delimiter, i);
        ...
        function compileGroup(optional, Ctor, tokens, str, i, imax) {
          var start = ++i;
          Ctor = Ctor ? token_OrGroup : token_Group;
    ...
    (function() {
      ...
      var Stream = class_create({
        ...
        processHead: function(expr) {
          ...
          if (false === isTagNameOptional(expr, id, cls)) {
            str = expr.tagName + str;
          }
      ...
      function isSingle(isArray) {
        var x = isArray.nodes;
        if (null == x) {
          return true;
        }
        isArray = 'number' === typeof x.length;
      ...
      function isTagNameOptional(tagName, id, cls) {
        if (null == id && null == cls) {
          return false;
        }
    ...
    (function() {
      ...
      (function() {
        Style = {
          transform: function(body, style, parent) {
            if (null != style.self) {
      ...
      function createParser(name, transform) {
        return function(str, i, imax, node) {
          ...
          if (62 === c) {
            var end = cursor_skipWhitespace(str, i + 1, imax);
            var end = str.charCodeAt(end);
            if (34 !== end && 39 !== end) {
              // "'
              var tuple = new Dom.Node(name, node);
              tuple.attr = attr;
              // `>` handle single without literal as generic mask node
              return [ tuple, i, go_tag ];
            }
          }
          end = i;
          tuple = 123 === c || 62 === c;
 ...
 //{}
            ...
            if (62 === c) {
              tuple = parser_parseLiteral(str, i, imax);
              if (null == tuple) {
                return null;
              }
              end = tuple[1];
          ...
          node = new ContentNode(name, node);
          node.content = body;
          node.attr = attr;
      ...
      function preprocess(result, body) {
        result = __cfg.preprocessor[result];
        if (null == result) {
          return body;
        }
        result = result(body);
    ...
    (function() {
      (function() {
        ...
        function createParser(tagName) {
          custom_Parsers[tagName] = function(str, i, end, node) {
            node = new DefineNode(tagName, node);
            end = lex_(str, i, end, node);
        ...
        var DefineNode = class_create(Dom.Node, {
          ...
          arguments: null,
          stringify: function(stream) {
            var extends_ = this['extends'], args_ = this['arguments'], as_ = this['as'], head = '';
            if (null != args_ && 0 !== args_.length) {
              head += ' (';
              head += toCommaSeperated(args_, get_arg);
              head += ')';
            }
            ...
            if (null != extends_ && 0 !== extends_.length) {
              head += ' extends ';
              head += toCommaSeperated(extends_, get_compo);
            }
            head = this.tagName + ' ' + this.name + head;
            stream.write(head);
            stream.openBlock('{');
    ...
    (function() {
      var IMPORT = 'import';
      var IMPORTS = 'imports';
      custom_Parsers[IMPORT] = function(str, i, end, parent) {
        var obj = {
          exports: null,
          alias: null,
          path: null,
          ...
          selector_parse = function(selector, type, direction) {
            ...
            while (index < length) {
              ...
              if (46 /*.*/ === c) {
                ...
                start = selector.indexOf('=', index);
                //if DEBUG
                -1 === start && console.error('Attribute Selector: should contain "="');
                // endif
                _prop = sel_key_ATTR;
                _key = selector.substring(index + 1, start);
                //slice out quotes if any
                c = selector.charCodeAt(start + 1);
                pseudo = 34 === c || 39 === c ? 2 : 1;
                _selector = selector.substring(start + pseudo, end - pseudo + 1);
                // increment, as cursor is on closed ']'
                end++;
              } else if (58 /*:*/ === c && 58 === selector.charCodeAt(index + 1)) {
                index += 2;
                var expr, start = index;
                do {
                  c = selector.charCodeAt(index);
                } while (c >= 97 /*a*/ && c <= 122 /*z*/ && ++index < length);
                pseudo = selector.substring(start, index);
                if (40 /*(*/ === c) {
                  start = ++index;
                  do {
                    c = selector.charCodeAt(index);
                ...
                var pseudo = PseudoSelectors(pseudo, expr);
                if (null == matcher) {
                  matcher = {
                    selector: '*',
                    nextKey: nextKey
    ...
    (function() {
      ManipAttr = {
        ...
        css: function(mix, val) {
          if (arguments.length <= 1 && 'string' === typeof mix) {
            ...
            var obj = this[0].attr.style;
            if (null == obj) {
              return null;
            }
            obj = css_parseStyle(obj);
      ...
      function css_parseStyle(style) {
        ...
        style.split(';').forEach(function(x) {
          ...
          var val = x.indexOf(':'), key = x.substring(0, val).trim(), val = x.substring(val + 1).trim();
          obj[key] = val;
        });
        return obj;
      }
    ...
    (function() {
      ManipDom = {
        ...
        wrap: function(result) {
          var $wrap = jMask(result);
          if (0 === $wrap.length) {
            log_warn('Not valid wrapper', result);
            return this;
          }
          result = coll_map(this, function(x) {
  ...
  (function() {
    ...
    /**
		 ...
		 * @memberOf mask
		 * @method merge
		 */    mask_merge = function(a, b, out, extra, stats) {
      if ('string' === typeof a) {
        a = parser_parse(a);
      }
      if ('string' === typeof b) {
      ...
      extra = _resolvePlaceholders(b, b, new Placeholders(null, b, extra));
      out = _merge(a, extra, out);
      if (null != stats) {
        stats.placeholders = extra;
      }
      extra = extra.$extra;
    ...
    function _mergeNode(node, placeholders, tmplNode, clonedParent) {
      ...
      var contentNodes = clonedParent && null != placeholders.$compos[clonedParent.tagName];
      if (contentNodes) {
        var val = null == node.nodes || 0 === node.nodes.length;
        if (false === val) {
          // Interpolate component slots
          return _cloneNode(node, placeholders, tmplNode, clonedParent);
        }
      }
      var nodes = node.attr.id;
      if (tagName === tag_PLACEHOLDER && null == nodes) {
        if (null != tmplNode) {
      ...
      if (tag_IF === tagName) {
        val = eval_(node.expression, placeholders, tmplNode);
        return val ? _merge(node.nodes, placeholders, tmplNode, clonedParent) : null;
      }
      if (null == nodes) {
        nodes = tagName.substring(1);
      }
      nodes = placeholders.$getNode(nodes, node.expression);
      if (null == nodes) {
        if (true === placeholders.opts.extending || contentNodes) {
          return node;
        }
        return null;
      }
      if (nodes.parent) {
        _modifyParents(clonedParent, nodes.parent);
      }
      var wrapperNode, contentNodes = nodes.nodes;
      if (void 0 !== node.attr.as) {
        tagName_ = node.attr.as;
        wrapperNode = {
          type: dom_NODE,
          tagName: tagName_,
          attr: _mergeAttr(node.attr, nodes.attr, placeholders, tmplNode),
          parent: clonedParent,
          nodes: contentNodes
        };
      ...
      nodes = _merge(node.nodes, _resolvePlaceholders(contentNodes, contentNodes, new Placeholders(placeholders)), nodes, wrapperNode || clonedParent);
      if (null != wrapperNode) {
    ...
    function _cloneNode(node, placeholders, tmplNode, clonedParent) {
      ...
      switch (tagName) {
       case ':template':
        var tmpl = interpolate_str_(node.attr.id, placeholders, tmplNode);
        Templates.register(tmpl, node.nodes);
        return null;

       case ':import':
        var tmpl = interpolate_str_(node.attr.id, placeholders, tmplNode), next = Templates.resolve(node, tmpl);
        return _merge(next, placeholders, tmplNode, clonedParent);
       ...
       case 'include':
        ...
        if (null != handler) {
          ...
          tmpl = proto.template || proto.nodes;
          placeholders.$isEmpty = false;
          next = _resolvePlaceholders(node.nodes, node.nodes, new Placeholders(placeholders, node.nodes));
    ...
    function _cloneDecorator(node, placeholders, tmplNode, out) {
      out = new Dom.DecoratorNode(node.expression, out || node.parent);
    ...
    function interpolate_str_(mix, placeholders, node) {
      ...
      while (index < length) {
        ...
        var x = isBlockEntry ? eval_ : interpolate_;
        x = x(expr, placeholders, node);
        if (null != x) {
          if (is_Function(x)) {
            isFn = true;
            x = x();
    ...
    function interpolate_(property, placeholders, node) {
      var obj = property.indexOf('.');
      if (-1 === obj) {
        log_warn('Merge templates. Accessing node', property);
        return null;
      }
      var tagName = property.substring(0, obj), id = tagName.substring(1), property = property.substring(obj + 1), obj = null;
      if (null != node) {
        if ('@attr' === tagName) {
    ...
    function _resolvePlaceholders(root, node, placeholders) {
      ...
      if (id === dom_NODE) {
        ...
        if (null != id && 64 === id.charCodeAt(0)) {
          ...
          if (null == placeholders[id]) {
            ...
            var count = placeholders[id];
            if (is_Array(count)) {
              count.push(out);
            } else {
              placeholders[id] = [ count, out ];
            }
          }
          return placeholders;
        }
      ...
      out = _resolvePlaceholders(root, node.nodes, placeholders);
  ...
  (function() {
    ...
    customTag_register('layout:view', {
      ...
      render: function(model, ctx, container, ctr, els) {
        var template = Templates.get(this.attr.master);
        template = mask_merge(template, this.nodes, null, {
          extending: true
        });
        builder_build(template, model, ctx, container, ctr, els);
      }
  ...
  (function() {
    ...
    (function() {
      _getDecorator = function(decoNode, model, ctx, deco) {
        var expr = decoNode.expression;
        deco = expression_eval(expr, _store, null, deco);
        if (null == deco) {
      ...
      _getDecoType = function(type) {
        var tagName = type.tagName, type = type.type;
      ...
      function initialize(x) {
        ...
        // is object
        var self = obj_create(x);
        if (x.hasOwnProperty('constructor')) {
          x = x.constructor.call(self);
          if (null != x) {
            return x;
          }
        }
    ...
    (function() {
      ...
      _wrapper_Fn = function(decoNode, deco, innerFn, target, key) {
        ...
        if (beforeInvoke || afterInvoke) {
          return function() {
            var overridenResult = _Array_slice.call(arguments);
            if (null != beforeInvoke) {
              var result = beforeInvoke.apply(this, overridenResult);
              if (is_Array(result)) {
                overridenResult = result;
              }
            }
            result = innerFn.apply(this, overridenResult);
            if (null != afterInvoke) {
              overridenResult = afterInvoke.call(this, result);
      ...
      function wrap(wrapperFn, decoratorNode, innerFn, target, key, model, ctx, deco) {
        deco = _getDecorator(decoratorNode, model, ctx, deco);
        if (null == deco) {
          return innerFn;
        }
    ...
    (function() {
      (function() {
        (function() {
          sourceUrl_get = function(i) {
            //if DEBUG
            var url = i.tagName;
            url = 'let' === url || 'define' === url ? forDefine : forNode;
            url = url(i), i = _sourceUrls[url];
            if (void 0 !== i) {
              i = ++_sourceUrls[url];
            }
            if (null != i) {
          ...
          //if DEBUG
          function forDefine(url) {
            var x = url, url = x.tagName + '_' + x.name;
            if ('let' === x.tagName) {
        ...
        defMethods_getSource = function(code, defProto, model, scopeVars) {
          var nodes = getFnNodes(code.nodes);
          if (null == nodes || 0 === nodes.length) {
            return;
          }
          var preproc = createFnBody(code, nodes);
          var sourceUrl = sourceUrl_get(code);
          // [[name],[value]]
          scopeVars = getScopeVars(code, defProto, model, scopeVars);
          code = createFnWrapperCode(code, preproc, scopeVars[0]);
          preproc = __cfg.preprocessor.script;
          if (preproc) {
            code = preproc(code);
          }
          if (null != sourceUrl) {
        ...
        defMethods_compile = function(defNode, defProto, vals, factory) {
          vals = defMethods_getSource(defNode, defProto, vals, factory);
          if (null == vals) {
            return;
          }
          var factory = vals[0], nodes = vals[1], vals = vals[2], factory = Function('return ' + factory), factory = factory(), fns = factory.apply(null, vals), imax = nodes.length, i = -1;
          while (++i < imax) {
            var node = nodes[i];
            var fn = fns[i];
        ...
        function createFnWrapperCode(name, body, code) {
          name = name.name.replace(/[:$]/g, '_') + 'Controller';
          code = 'function ' + name + ' (' + code.join(',') + ') {\n';
          code += body;
          code += '\n}';
          return code;
        }
      ...
      (function() {
        nodeMethod_getSource = function(node, model, owner) {
          var sourceUrl = sourceUrl_get(node), name = node.getFnName(), args = node.args, preproc = node.body, code = '';
          if (node.flagAsync) {
            code += 'async ';
          }
        ...
        nodeMethod_compile = function(node, factory, vars) {
          var vals = node.fn;
          if (null != vals) {
            return vals;
          }
          vals = getScopeVars(node, node, vars), factory = nodeMethod_getSource(node, factory, vars), 
          vars = vals[0], vals = vals[1], factory = vars.concat([ 'return ' + factory ]), 
          factory = Function.apply(null, factory);
      ...
      (function() {
        function create(tagName) {
          return function(str, i, end, node) {
            var body = str.indexOf('{', i) + 1, head = parseHead(
            //tagName, str.substring(i, start - 1)
            tagName, str, i, body);
            if (null == head) {
              parser_error('Method head syntax error', str, i);
            }
            end = cursor_groupEnd(str, body, end, 123, 125), body = str.substring(body, end), 
            node = null == head ? null : new MethodNode(tagName, head, body, node);
            return [ node, end + 1, 0 ];
          };
        }
        var parseHead;
        (function() {
          ...
          parseHead = function(name, str, i, end) {
            var head = new MethodHead();
            end = lex_(str, i, end, head, true);
      ...
      (function() {
        ...
        (function() {
          ...
          function attach(node, pipe) {
            var pipes = pipe.pipes;
            if (null == pipes) {
              pipes = pipe.pipes = {};
            }
            var type = parse(node.name);
            if (null == type) {
              return;
            }
            var name = type[0], type = type[1], pipe = pipe.pipes[name];
            if (null == pipe) {
              pipe = pipes[name] = {};
            }
            pipe[type] = node.fn;
  ...
  (function() {
    (function() {
      custom_Statements['log'] = {
        render: function(node, model, ctx, container, arr) {
          arr = expression_evalStatements(node.expression, model, ctx, arr);
    ...
    (function() {
      (function() {
        Define = {
          ...
          registerGlobal: function(node, model, ctr, Ctor) {
            Ctor = Define.create(node, model, ctr, Ctor);
            customTag_register(node.name, Ctor);
          },
          registerScoped: function(node, model, ctr, Ctor) {
            Ctor = Define.create(node, model, ctr, Ctor);
        ...
        function compo_prototype(node, compoName, tagName, attr, nodes, owner, model, Base) {
          ...
          var Proto = obj_extend({
            ...
            renderStart: function(model, ctx, el) {
              model;
          ...
          for (var i = 0; i < imax; i++) {
            ...
            if (x.type === Dom.DECORATOR) {
              var name = i;
              i = Decorator.goToNode(nodes, i, imax);
              decorators = _Array_slice.call(nodes, name, i);
              x = nodes[i];
            }
            name = x.tagName;
            if ('function' === name) {
              ...
              if (null != x.decorators) {
                var result = Decorator.wrapMethod(x.decorators, type, Proto, x.name, model, null, owner);
                if (is_Function(result)) {
                  Proto[x.name] = result;
                }
              }
              ...
              if (x.flagStatic) {
                ...
                Proto.meta.statics[x.name] = type;
              }
              continue;
            }
            if ('slot' === name || 'event' === name) {
              ...
              type = name + 's';
              var register = Proto[type];
              if (null == register) {
                register = Proto[type] = {};
              }
              register[x.name] = x.flagPrivate ? slot_privateWrap(x.fn) : x.fn;
              if (null != x.decorators) {
                result = Decorator.wrapMethod(x.decorators, x.fn, register, x.name, model, null, owner);
                if (is_Function(result)) {
                  register[x.name] = result;
                }
              }
              continue;
            }
            ...
            if ('define' === name || 'let' === name) {
              register = 'define' === name ? Define.registerGlobal : Define.registerScoped;
        ...
        function compo_extends(extends_, model, ctr) {
          ...
          while (++i < imax) {
            x = extends_[i];
            if (x.compo) {
              var obj = customTag_get(x.compo, ctr);
              if (null != obj) {
                args.unshift(obj);
                continue;
              }
              obj = expression_eval(x.compo, model, null, ctr);
              if (null != obj) {
                args.unshift(obj);
                continue;
              }
        ...
        function compo_fromNode(node, model, Ctor, Proto) {
          var tagName, attr, extends_ = node['extends'], as_ = (node['arguments'], node['as']);
          if (null != as_) {
            var name = parser_parse(as_);
            tagName = name.tagName;
            attr = obj_extend(node.attr, name.attr);
          }
          name = node.name, Proto = compo_prototype(node, name, tagName, attr, node.nodes, Ctor, model, Proto), 
          Ctor = compo_extends(extends_, model, Ctor);
          Ctor = Component.createExt(Proto, Ctor);
    ...
    (function() {
      var Compo = {
        ...
        render: function(model, div, container) {
          this.html = jMask(this.nodes).text(model, div, this);
    ...
    (function() {
      ...
      (function() {
        css_ensureScopedStyles = function(str_, node, id) {
          var attr = node.attr;
          if (null == attr.scoped && null == attr[KEY]) {
            return str_;
          }
          if (false === is_String(str_)) {
        ...
        function getScopeIdentity(identity, el) {
          identity = 'scoped__css__' + identity.id;
          if (el.id) {
      ...
      var ElementContent = class_create(customTag_Base, {
        meta: {
          mode: 'server'
        },
        tagName: null,
      ...
      var GlobalContent = class_create(ElementContent, {
        render: function(model, ctx, el) {
          manager_get(ctx, el).append(this.tagName, this);
        }
      });
      ElementContent = class_create(ElementContent, {
        render: function(model, ctx, el) {
  ...
  (function() {
    ...
    function _run(model, ctx, container, ctr) {
      ...
      while (++i < imax) {
        script = scripts[i];
        var ctx_ = script.getAttribute('type');
        if ('text/mask' !== ctx_ && 'text/x-mask' !== ctx_) {
          continue;
        }
        var fragment = script.getAttribute('data-run');
        if (null == fragment) {
          continue;
        }
        if ('auto' === fragment) {
        ...
        found = true;
        ctx_ = new builder_Ctx(ctx);
        fragment = builder_build(parser_parse(script.textContent), model, ctx_, null, ctr);
        if (true === ctx_.async) {
          wait++;
          ctx_.done(resumer);
        }
  ...
  (function() {
    ...
    (function() {
      ...
      AsyncWalker.prototype = {
        ...
        push: function(node, parent, step) {
          step = new Step(node, parent, step);
        ...
        process: function(mod) {
          ...
          next = true === break_ ? null : this.getNext(next);
          if (null == next) {
            this.done(this.root);
            return;
          }
      ...
      Modifier.prototype = {
        ...
        process: function(i) {
          if (null != this.replace) {
            this.deep = false;
            i.parent.nodes[i.index] = this.replace;
            return;
          }
          if (true === this.remove) {
            this.deep = false;
            var arr = i.parent.nodes, i = i.index;
  ...
  (function() {
    ...
    (function() {
      (function() {
        ...
        path_getExtension = function(match) {
          var query = match.indexOf('?');
          if (-1 !== query) {
            match = match.substring(0, query);
          }
          match = rgx_EXT.exec(match);
          return null == match ? '' : match[1];
        };
        path_fromPrfx = function(sfx, prefixes) {
          var i = sfx.indexOf('/');
          if (-1 === i) {
            i = sfx.length;
          }
          var route = sfx.substring(1, i);
          sfx = sfx.substring(i + 1);
          route = prefixes[route];
          if (null == route) {
            return null;
          }
          if (1 === route.indexOf('{')) {
          ...
          while (++i < imax) {
            var x = routeArr[i];
            var end = x.indexOf('}');
            var y = 0 | x.substring(0, end);
            y = y < sfxArrL ? sfxArr[y] : sfxArr[sfxArrL - 1];
        ...
        path_resolveCurrent = function() {
          ...
          function fromBaseTag() {
            var b = _global.document.head;
            if (null == b) {
              return fromLocation();
            }
            b = b.querySelector('base');
            if (null == b) {
              return fromLocation();
            }
            return b.href;
        ...
        path_normalize = function(path_) {
          path_ = path_.replace(/\\/g, '/').replace(/([^:\/])\/{2,}/g, '$1/').replace(/^\.\//, '').replace(/\/\.\//g, '/');
      ...
      (function() {
        ...
        (function() {
          ...
          (function() {
            script_get = function(res, cb) {
              res = new Resource(res).done(function(exports) {
                cb(null, exports);
              }).fail(function(err) {
                cb(err);
              });
        ...
        function get(fn, url, dfr) {
          url = path_resolveUrl(url, Module.resolveLocation(dfr));
          if (url in Cache) {
            return Cache[url];
          }
          dfr = Cache[url] = new class_Dfr();
      ...
      listeners_on('config', function(fn) {
        var modules = fn.modules;
        if (null == modules) {
          return;
        }
        fn = Loaders[modules];
      ...
      function createTransport(loaderFactoryFn) {
        return function(v) {
          var fn = loaderFactoryFn(), path = v, v = _opts.version;
          if (null != v) {
    ...
    (function() {
      u_resolveLocation = function(ctx, ctr, path) {
        if (null != path) {
      ...
      u_setOption = function(options, key, val) {
        if ('base' === key || 'nsBase' === key) {
          var current = path_normalize(val);
        ...
        current = obj_getProperty(options, key);
      ...
      u_resolvePathFromImport = function(type, ctx, ctr, module, makeAbs) {
        var path = type.path;
        if (null == path && null != type.namespace) {
          path = fromNs(type);
        }
        if ('@' === path[0]) {
          ...
          if (null == path) {
            path = type.path;
            warn_withNode('Prefix not defined: ' + path, type);
          }
        }
        if ('/' === path[path.length - 1] && null != type.exports) {
          path += type.exports[0].name;
        }
        if (false === hasExt(path)) {
          var c = path.charCodeAt(0);
          if (47 === c || 46 === c) {
      ...
      function toAbsolute(path, ctx, ctr, module) {
        path;
      ...
      function fromNs(node) {
        var default_ = node.contentType || 'script';
        var path = node.namespace.replace(/\./g, '/');
        if ('/' === path[0]) {
          path = '.' + path;
        } else {
          var exp = _opts.nsBase;
          if (null != exp) {
            path = path_combine(exp, path);
          }
        }
        var name = node.exports;
        if (null == name) {
          path += '/' + node.alias;
          ...
          name = exp.name;
          path += '/' + name;
          if ('script' === default_ && true !== _opts.es6Modules) {
            node.alias = exp.alias || name;
            node.exports = null;
          }
        }
        default_ = _opts.ext[default_] || default_;
        path += '.' + default_;
        return path;
      }
      u_resolveNpmPath = function(contentType, domainMatch, parentLocation, cb) {
        var name = /^([\w\-]+)/.exec(domainMatch)[0];
        var resource = domainMatch.substring(name.length + 1);
        if (resource && false === hasExt(resource)) {
          resource += '.' + _ext[contentType];
        }
        var root = '';
        domainMatch = /(\w{2,5}:\/{2,3}[^/]+)/.exec(parentLocation);
        if (domainMatch) {
          root = domainMatch[0];
        ...
        function onComplete(error, next) {
          var json;
          if (next) {
            try {
    ...
    (function() {
      ...
      type_isMask = function(ext) {
        var type = ext.contentType, ext = type || path_getExtension(ext.path);
        return '' === ext || 'mask' === ext || 'html' === ext;
      };
      type_get = function(ext) {
        var type = ext.contentType;
        if (null == type && null != ext.moduleType) {
          var x = _typeMappings[ext.moduleType];
          if (null != x) {
            return x;
          }
        }
        ext = type || path_getExtension(ext.path);
        if ('' === ext || 'mask' === ext) {
          return 'mask';
        }
    ...
    (function() {
      ...
      function ensure(hash) {
        var type = type_getModuleType(hash);
        hash = _cache[type];
        if (null == hash) {
          hash = _cache[type] = {};
        }
    ...
    (function() {
      tools_getDependencies = function(ast, path, dfr) {
        var opts = obj_extendDefaults(dfr, defaultOptions);
        dfr = new class_Dfr();
        ast = 'string' === typeof ast ? parser_parse(ast) : ast;
      ...
      function walk(ast, path, opts, done) {
        ...
        function visit(type, next) {
          if ('import' !== type.tagName) {
            return next();
          }
          var path = resolvePath(type, location);
          type = type_get(type);
          if (false === opts.deep) {
      ...
      function resolvePath(type, location) {
        var path = type.path, type = type.contentType;
      ...
      function build_data(path, opts, done) {
        return class_Dfr.run(function(resolve, reject) {
          _file_get(path).fail(reject).done(function(mix) {
            try {
              script = 'string' === typeof mix ? JSON.parse(mix) : mix;
            } catch (error) {
              reject(error);
              return;
            }
            var script = JSON.stringify(script, null, opts.minify ? 4 : void 0);
    ...
    (function() {
      ...
      (function() {
        (function() {
          (function() {
            ...
            m_createModule = function(module, ctx, endpoint, parent) {
              endpoint = u_resolvePathFromImport(module, ctx, endpoint, parent), endpoint = new Endpoint(endpoint, module.contentType, module.moduleType), 
            ...
            m_registerModule = function(mix, endpoint, ctx, ctr, module) {
              endpoint.path = u_resolvePath(endpoint.path, ctx, ctr, module);
              module = m_createModule(endpoint, ctx, ctr, module);
          ...
          IImport = class_create({
            ...
            hasExport: function(name) {
              ...
              if (null != exports) {
                var imax = exports.length, i = -1;
                while (++i < imax) {
                  var expName = exports[i];
                  expName = null == expName.alias ? expName.name : expName.alias;
                  if (expName === name) {
                    return true;
                  }
                }
            ...
            registerExport_: function(ctr, exportName, name, obj) {
        ...
        ImportMask = i_Types['mask'] = class_create(IImport, {
          ...
          getHandler: function(x) {
            ...
            if (null != module.error) {
              if (this.hasExport(x)) {
                this.logError_('Resource for the import `' + x + '` not loaded');
                return this.empty;
              }
              return null;
            }
            x = this.getExportedName(x);
            if (null == x) {
              return null;
            }
      ...
      (function() {
        i_createImport = function(node, ctx, endpoint, module) {
          endpoint = u_resolvePathFromImport(node, ctx, endpoint, module), endpoint = new Endpoint(endpoint, node.contentType, node.moduleType);
    ...
    (function() {
      ...
      ModuleMask = m_Types['mask'] = class_create(IModule, {
        ...
        preprocess_: function(ast, next) {
          ast = 'string' === typeof ast ? parser_parse(ast, this.path) : ast;
          this.source = ast;
          this.importItems = [];
          this.exports = {
            __nodes__: [],
          ...
          while (++i < imax) {
            ...
            switch (x.tagName) {
             ...
             case 'module':
              var path = u_resolvePath(x.attr.path, null, null, this), endpoint = x.attr.contentType, endpoint = new Endpoint(path, endpoint);
      ...
      function _createExports(nodes, model, module) {
        ...
        while (++i < imax) {
          var compoName = nodes[i];
          var name = compoName.tagName;
          if ('define' === name || 'let' === name) {
            var Proto = {
      ...
      function _module_getHandler(module, name) {
        ...
        var Ctor = handlers[name];
        if (null != Ctor) {
          return Ctor;
        }
        // check private components store
        handlers = handlers.__handlers__;
    ...
    (function() {
      ...
      (function() {
        m_Types['html'] = class_create(ModuleMask, {
          type: 'mask',
          preprocess_: function(ast, next) {
            ast = 'string' === typeof ast ? parser_parseHtml(ast) : ast;
      ...
      (function() {
        ...
        custom_Tags['module'] = class_create({
          constructor: function(node, model, ctx, container, ctr) {
            ...
            var endpoint = node.attr.type;
            endpoint = new Endpoint(path, endpoint);
            m_registerModule(node.nodes, endpoint, ctx, ctr);
          },
          render: fn_doNothing
        });
        custom_Tags['import:base'] = function(node, model, ctx, el, x) {
          x = expression_eval(node.expression, model, ctx, x);
          m_cfg('base', x);
        };
        custom_Tags['import:cfg'] = function(node, model, ctx, el, args) {
          args = expression_evalStatements(node.expression, model, ctx, args);
        ...
        custom_Tags[IMPORT] = class_create({
          ...
          renderStart: function(model, resume) {
            if (null == this.module) {
              return;
            }
            resume = Component.pause(this, resume);
            var self = this;
        ...
        custom_Tags[IMPORTS] = class_create({
          ...
          getHandlers: function() {
            var handlers = {};
            var x, arr = this.importItems, imax = arr.length, i = -1;
            while (++i < imax) {
              x = arr[i];
              if ('mask' !== x) {
                continue;
    ...
    (function() {
      ...
      var AStrategy = /** @class */ function() {
        ...
        AwaitCtr.prototype.splitNodes_ = function() {
          ...
          coll_each(this.nodes, function(current) {
            var prop = current.tagName, nodes = current.nodes;
            prop = map[prop];
            if (null == prop) {
              prop = 'completeNodes';
              nodes = [ current ];
            ...
            if (current.expression) {
              this[prop + 'Expr'] = current.expression;
            }
            current = this[prop];
            if (null == current) {
              this[prop] = nodes;
        ...
        AwaitCtr.prototype.initStrategy_ = function() {
          var msg = this.expression;
          if (msg && null == this.keys) {
          ...
          if (null != this.keys) {
            ...
            if (this.keys.length > 1 && null == msg) {
              this.strategy = new RefOrImportStrategy(this);
              return;
            }
          }
          msg = 'Unsupported await strategy. `(';
          msg += this.expression || '';
          msg += ') ';
        ...
        AwaitCtr.prototype.await_ = function(model, ctx, resume) {
          this.progress_(ctx, resume);
          this.strategy.process(model, ctx, resume);
          resume = builder_resumeDelegate(this, model, ctx, resume);
          var self = this;
        ...
        AwaitCtr.prototype.progress_ = function(ctx, container) {
          var node = this.progressNodes;
          if (null == node) {
            return;
          }
          var hasLiteral = node.some(function(x) {
            return x.type === Dom.TEXTNODE;
          });
          if (hasLiteral) {
            node = jMask('div').append(node);
          }
          node = {
            type: Dom.COMPONENT,
            nodes: node,
      ...
      custom_Tags['await'] = AStrategy;
      AStrategy = /** @class */ function(_super) {
      ...
      var RefOrImportStrategy = /** @class */ function(_super) {
        ...
        RefOrImportStrategy.prototype.process = function() {
          var self = this;
          var arr = this.awaiter.expression ? _getNames(this.awaiter.expression) : this.awaiter.keys;
          arr = arr.map(function(ref) {
      ...
      var ComponentStrategy = /** @class */ function(_super) {
        ...
        function ComponentStrategy(_this, name, expr) {
      ...
      var AwaitableRender = /** @class */ function(_super) {
        ...
        function AwaitableRender(name, node, expression, nodes, model, ctx, container, ctr) {
          var _this = _super.call(this) || this;
  ...
  (function() {
    (function() {
      ...
      custom_Statements['if'] = {
        ...
        render: function(node, model, ctx, container, ctr, compo) {
          var type = expression_getType(node.expression);
          if (type === exp_type_Sync) {
            var Ctor = getNodesSync(node, model, ctx, ctr);
            if (null != Ctor) {
              builder_build(Ctor, model, ctx, container, ctr, compo);
            }
            return;
          }
          Ctor = null !== ObservableIfCtor && void 0 !== ObservableIfCtor ? ObservableIfCtor : ObservableIfCtor = custom_Tags['+if'];
          compo = new Ctor(node, model, ctx, container, ctr, compo);
          compo_addChild(ctr, compo);
          compo.render();
        }
      };
      function getNodesSync(node, model, ctx, ctr) {
        do {
          var expr = expression_eval(node.expression, model, ctx, ctr, node);
          if (expr) {
            return node.nodes;
          }
    ...
    (function() {
      ...
      function for_proto_serializeScope(scope, model) {
        var val = this, expr = val.expression, key = val.key, propVal = val.propVal;
        val = scope[propVal];
    ...
    (function() {
      custom_Statements['each'] = {
        render: function(node, array, ctx, container, ctr, children) {
          array = expression_eval(node.expression, array, ctx, ctr);
          if (null == array) {
            return;
          }
    ...
    (function() {
      custom_Statements['with'] = {
        render: function(node, obj, ctx, el, ctr, elements) {
          obj = expression_eval(node.expression, obj, ctx, ctr);
          if (null == obj) {
    ...
    (function() {
      custom_Statements['switch'] = {
        render: function(nodes, model, ctx, el, ctr, elements) {
          var value = expression_eval(nodes.expression, model, ctx, ctr), nodes = getNodes(value, nodes.nodes, model, ctx, ctr);
          if (null == nodes) {
            return;
          }
    ...
    (function() {
      custom_Statements['visible'] = {
        toggle: toggle,
        render: function(node, model, ctx, container, visible, children) {
          var els = [];
          builder_build(node.nodes, model, ctx, container, visible, els);
          arr_pushMany(children, els);
          visible = expression_eval(node.expression, model, ctx, visible);
          toggle(els, visible);
        }
      };
    ...
    (function() {
      custom_Statements['repeat'] = {
        render: function(node, model, ctx, container, ctr, children) {
          var run = expression_eval, str = node.expression, repeat = str.split('..'), els = +run(repeat[0] || '', model, ctx, ctr), end = +run(repeat[1] || '', model, ctx, ctr);
          if (els !== els || end !== end) {
  ...
  (function() {
    ...
    (function() {
      ...
      (function() {
        (function() {
          expression_eval_safe = function(expr, model, ctx, ctr, x) {
            x = expression_eval(expr, model, ctx, ctr, x);
            return null == x ? '' : x;
          };
        })();
        /**
    ...
    (function() {
      ...
      ValidatorProvider = {
        ...
        validate: validate,
        validateUi: function(fns, val, error, el, oncancel) {
          error = validate(fns, val, error);
          if (null != error) {
      ...
      function fn_fromModel(model, prop) {
        ...
        if (null != Validate) {
          var i = null;
          if (is_Function(i = Validate)) {
            return i;
          }
          if (is_Function(i = Validate[prop])) {
            return i;
          }
        }
        i = prop.indexOf('.');
      ...
      function ui_notifyInvalid(el, message, oncancel) {
    ...
    (function() {
      ...
      (function() {
        ...
        var objectWay = {
          ...
          set: function(model, property, value, provider) {
            var setter = provider.objSetter;
            if (null == setter) {
              obj_setProperty(model, property, value);
              return;
            }
            var ctr = provider.ctr.parent, model = provider.model;
        ...
        var DateTimeDelegate = {
          domSet: function(format) {
            return function(prov, date) {
              date = date_ensure(date);
              prov.element.value = null == date ? '' : format(date);
            };
          },
          objSet: function(extend) {
            return function(obj, prop, target) {
              var date = date_ensure(target);
              if (null == date) {
                return;
              }
              target = obj_getProperty(obj, prop);
              if (null == target) {
        ...
        DomObjectTransport = {
          ...
          SELECT: {
            get: function(val) {
              var opt = val.element, val = opt.selectedIndex;
              if (-1 === val) {
                return '';
              }
              opt = opt.options[val], val = opt.getAttribute('value');
        ...
        function formatDate(DD) {
          var YYYY = DD.getFullYear(), MM = DD.getMonth() + 1, DD = DD.getDate();
          return (YYYY + '').padStart(4, '0') + '-' + (MM < 10 ? '0' : '') + MM + '-' + (DD < 10 ? '0' : '') + DD;
        }
        function formatTime(M) {
          var H = M.getHours(), M = M.getMinutes();
          return H + ':' + (M < 10 ? '0' : '') + M;
        }
        function formatMonth(MM) {
          var YYYY = MM.getFullYear(), MM = MM.getMonth() + 1;
      ...
      (function() {
        signal_parse = function(str, isPiped, defaultType) {
          var signalName, signal, signals = str.split(';'), set = [], i = 0, imax = signals.length;
          for (;i < imax; i++) {
            signalName = signals[i].split(':');
            if (1 !== signalName.length && 2 !== signalName.length) {
              log_error('Too much ":" in a signal def.', signals[i]);
              continue;
            }
            signal = 2 === signalName.length ? signalName[0] : defaultType;
            signalName = signalName[2 === signalName.length ? 1 : 0];
            signal = signal_create(signalName.trim(), signal, isPiped);
            if (null != signal) {
              set.push(signal);
            }
          }
        ...
        function signal_create(signal, type, index) {
          if (true !== index) {
            return {
              signal: signal,
              type: type
      ...
      BindingProvider = /** @class */ function() {
        function BindingProvider(domDefaultKey, element, expression, refs) {
          this.model = domDefaultKey;
          ...
          if (null == refs) {
            refs = 'dual';
            var defs = expression.compoName;
            if (':bind' === defs || 'bind' === defs) {
              refs = 'single';
            }
          }
          var attr = expression.attr;
          this.owner = expression.parent;
          this.bindingType = refs;
          ...
          var isCompoBinder = expression.node.parent.tagName === this.owner.compoName;
          domDefaultKey = 'dom-supports-default';
          defs = attr[domDefaultKey];
          ...
          if (isCompoBinder) {
            if ('observe' === this.domListenerType) {
              ...
              var index = 1 === element.nodeType && ('INPUT' === element.tagName || 'TEXTAREA' === element.tagName);
              if (false === index) {
          ...
          index = attr[A_dom_slot];
          if (null != index) {
            this.slots = {};
            // @hack - place dualb. provider on the way of a signal
            //
            var pipeName = expression.parent, str = pipeName.parent;
            pipeName.parent = this;
            this.parent = str;
            this.slots[index] = function(sender, value) {
              this.domChanged(sender, value);
            };
          }
          /*
			         *  @obsolete: attr name : 'x-pipe-slot'
			         */          pipeName = attr['object-pipe-slot'] || attr['x-pipe-slot'];
          if (pipeName) {
            str = pipeName, index = str.indexOf('.'), pipeName = str.substring(0, index), signal = str.substring(index + 1);
            this.pipes = {};
            this.pipes[pipeName] = {};
          ...
          expression = attr.expression || expression.expression;
          if (expression) {
            this.expression = expression;
            if (null == this.value && 'single' !== refs) {
              refs = expression_varRefs(this.expression);
        ...
        BindingProvider.prototype.objectChanged = function(pipe) {
          if (this.dismiss-- > 0) {
            return;
          }
          var signal = true === this.locked;
          if (signal) {
            log_warn('Concurrent change detected', this);
            // Set the value to dom anyway, but skip emitting
          }
          this.locked = true;
          if (null == pipe || null != this.objGetter) {
            pipe = this.objectWay.get(this, this.expression);
          }
          if (null != this.mapToDom) {
            pipe = expression_callFn(this.mapToDom, this.model, null, this.ctr, [ pipe ]);
          }
          this.domWay.set(this, pipe);
          if (this.log) {
            console.log('[BindingProvider] objectChanged -', pipe);
          }
          if (false === signal) {
            signal = this.signal_objectChanged;
            if (null != signal) {
              Component.signal.emitOut(this.ctr, signal, this.ctr, [ pipe ]);
            }
            pipe = this.pipe_objectChanged;
            if (null != pipe) {
        ...
        BindingProvider.prototype.domChanged = function(event, val) {
          ...
          var obj = this.validate(val);
          if (null == obj) {
            this.dismiss = 1;
            var tuple = expr_getHost(this.value, this.model, null, this.ctr.parent);
            if (null != tuple) {
              var obj = tuple[0], pipe = tuple[1];
              this.objectWay.set(obj, pipe, val, this);
            }
            this.dismiss = 0;
            if (this.log) {
        ...
        BindingProvider.prototype.validate = function(val_) {
          var fns = this.validations, ctr = this.ctr, el = this.element;
          if (null == fns || 0 === fns.length) {
            return null;
          }
          val_ = 0 !== arguments.length ? val_ : this.domWay.get(this);
          return ValidatorProvider.validateUi(fns, val_, ctr, el, this.objectChanged.bind(this));
        };
        BindingProvider.create = function(model, el, ctr, provider) {
          /* Initialize custom provider */
          var CustomProvider = ctr.attr.bindingProvider, CustomProvider = null == CustomProvider ? null : CustomProviders[CustomProvider];
          if ('function' === typeof CustomProvider) {
            return new CustomProvider(model, el, ctr, provider);
          }
          provider = new BindingProvider(model, el, ctr, provider);
    ...
    (function() {
      ...
      (function() {
        ...
        ValidationCompo = class_create({
          ...
          renderStart: function(model, ctx, fn) {
            this.element = fn;
            fn = this.attr.value;
            if (fn) {
              fn = ValidatorProvider.getFnFromModel(model, fn);
              if (null != fn) {
          ...
          /**
				     ...
				     */
          validate: function(type, fns, oncancel) {
            var element = null == fns ? this.element : fns, value = type;
            if (0 === arguments.length) {
            ...
            fns = this.validators, type = this.attr.silent ? 'validate' : 'validateUi';
          ...
          initValidators: function() {
            ...
            for (var key in attr) {
              ...
              var fn = isDefault ? message + ' Validation: `' + key + '`' : message;
              fn = ValidatorProvider.getFnByName(key, attr[key], fn);
              if (null != fn) {
                this.validators.push(fn);
              }
            }
      ...
      (function() {
        ...
        var DualbindCompo = class_create({
          renderEnd: function(elements, fn, ctx, container) {
            this.provider = BindingProvider.create(fn, container, this);
            ...
            if (null == this.attr['no-validation']) {
              fn = ValidatorProvider.getFnFromModel(fn, this.provider.value);
              if (null != fn) {
    ...
    (function() {
      var ABindedStatement, expression_subscribe, el_renderPlaceholder, arr_createRefs, list_sort, list_update, list_remove, ALoopBindedStatement, dom_removeAll, dom_insertAfter, dom_insertBefore, compo_fragmentInsert, compo_renderChildren, compo_dispose, compo_disposeChildren, compo_inserted;
      var _renderPlaceholder, _compo_initAndBind, els_toggleVisibility;
      (function() {
        (function(name, node, model, ctx, controller) {
          return custom_Statements[name].getNodes(node, model, ctx, controller);
        });
        _renderPlaceholder = function(placeholder, compo, container) {
      ...
      (function() {
        ...
        (function() {
          ...
          expression_subscribe = function(obs, model, ctx, ctr, cb, once) {
            if ('.' === obs) {
              if (null != model) {
                obj_addMutatorObserver(model, cb);
              }
            ...
            var ast = _parseCached(obs, ctr);
            obs = expression_getType(ast);
            if (obs === exp_type_Observe) {
              obs = _evaluateAstDeferredInner(ast, model, ctx, ctr);
              if (true === once && void 0 !== obs.value) {
                cb(obs.value);
                return;
              }
              if (null === obs || void 0 === obs ? void 0 : obs.subscribe) {
            ...
            function onInnerChanged(partial) {
              ...
              cb.apply(void 0, __spreadArrays([ val ], args));
            }
            if (true === once) {
              onInnerChanged();
              return;
            }
            toggleExpressionsBindings(obj_addObserver, ast, model, ctr, onInnerChanged);
            // send current value
            onInnerChanged();
        ...
        var ObservableNodes = /** @class */ function() {
          ...
          ObservableNodes.prototype.runSwitch = function(err, result) {
            var expr = this.switch[this.index];
            expr.result = result;
            expr.busy = false;
            if (err) {
              this.onResolved();
            ...
            if (result) {
              this.onResolved();
              this.cb(null, expr.node, this.index);
              return;
            }
          ...
          ObservableNodes.prototype.onChanged = function(err, s, result) {
            if (this.disposed) {
              return;
            }
            s = this.switch[s];
          ...
          ObservableNodes.prototype.createSwitch = function(i) {
            ...
            var meta = this.evalSwitchCurrent();
            meta = this.switch[i] = {
              busy: false,
              type: exp_type_Sync,
              node: this.cursor,
        ...
        ObservableIf = /** @class */ function() {
          ...
          ObservableIf.prototype.renderEnd = function(els, model, ctx, container, ctr) {
            var _this = this;
            var s = null !== (s = null === (s = this.attr) || void 0 === s ? void 0 : s['switch-index']) && void 0 !== s ? s : 0;
            this.index = Number(s);
            this.placeholder = null !== (s = this.placeholder) && void 0 !== s ? s : el_renderPlaceholder(this.el);
            this.obs = new ObservableNodes(this.node, this.model, this.ctx, this.ctr, function(err, node, index) {
              return _this.show(err, node, index);
            });
            s = this.obs.initialize(this.index);
            this.Switch[this.index] = {
              node: s.node,
              elements: els
            };
          };
          ObservableIf.prototype.show = function(err, els, _b) {
            var frag = this.index;
            var owner = this.Switch;
            if (frag === _b) {
              return;
            }
            if (frag > -1) {
              els_toggleVisibility(owner[frag].elements, false);
            }
            if (-1 === _b) {
              this.index = -1;
              return;
            ...
            owner = null === (frag = current.node.parent) || void 0 === frag ? void 0 : frag.tagName;
            var _b = 'define' === owner || 'let' === owner;
            els = current.node.nodes;
            frag = _document.createDocumentFragment();
            owner = {
              components: [],
              parent: this.ctr
            };
            els = compo_renderElements(els, this.model, this.ctx, frag, owner);
            ...
            if (_b) {
              null === (_b = this.ctr.$) || void 0 === _b ? void 0 : _b.add(els);
            }
      ...
      (function() {
        (function() {
          ...
          (function() {
            ...
            //     return arr;
            // };
            compo_dispose = function(compo, compos) {
              if (null == compo) {
                return false;
              }
              ...
              compos = compos && compos.components || compo.parent && compo.parent.components;
              if (null == compos) {
          ...
          (function() {
            ...
            list_update = function(self, deleteIndex, deleteCount, insertIndex, fragment) {
              var _a;
              ...
              if (null != insertIndex && fragment && fragment.length) {
                i = compos.length;
                fragment = self.build(fragment, null, null);
                var arrivedCompos = compos.splice(i);
                compo_fragmentInsert(self, insertIndex, fragment, self.placeholder);
                compos.splice.apply(compos, __spreadArrays([ insertIndex, 0 ], arrivedCompos));
          ...
          (function() {
            ...
            ABindedStatement = /** @class */ function() {
              ...
              ABindedStatement.prototype.renderEnd = function(els, model, ctx, container, ctr) {
                var _a;
                this.placeholder = null !== (_a = this.placeholder) && void 0 !== _a ? _a : el_renderPlaceholder(this.el);
                this._bootstrap();
                this.subscription = expression_subscribe(this._getExpression(), this.model, this.ctx, this.ctr, this.onChanged, is_NODE ? true : false);
              };
              ABindedStatement.prototype.onChanged = function(value) {
                ...
                if (this.rendered) {
                  this.refresh.apply(this, __spreadArrays([ value ], args));
                  return;
                }
                if (is_Array(value)) {
          ...
          ALoopBindedStatement = /** @class */ function(_super) {
            ...
            ALoopBindedStatement.prototype.refresh = function(value, method, args, result) {
              ...
              switch (method) {
               ...
               case 'splice':
                var removed = args;
                var sliceStart = removed[0];
                var sliceRemove = 1 === removed.length ? this.components.length : removed[1];
                removed = args.length > 2 ? array.slice(removed[0], removed.length - 2 + removed[0]) : null;
                list_update(this, sliceStart, sliceRemove, sliceStart, removed);
                break;
        ...
        ObservableFor = /** @class */ function(_super) {
          ...
          ObservableFor.prototype._beforeRender = function() {
            var expr = For.parseFor(this.expression), prop1 = expr[0], prop2 = expr[1], type = expr[2], expr = expr[3];
            this.prop1 = prop1;
            this.prop2 = prop2;
            this.type = type;
            this.expr = expr;
      ...
      (function() {
        var EachBinded = {
          ...
          //modelRef: null,
          render: function(model, ctx, container, array, children) {
            //this.modelRef = this.expression;
            array = expression_eval(this.expression, model, ctx, array);
            if (null == array) {
              return;
            }
      ...
      (function() {
        (function() {
          ...
          customTag_register('+switch', {
            ...
            render: function(model, ctx, container, ctr, children) {
              var index = expression_eval_safe(this.expression, model, ctx, ctr);
              resolveNodes(index, this.nodes, model, ctx, ctr);
          ...
          SwitchStatement.prototype = {
            ...
            refresh: function(elements) {
              var compo = this, Switch = compo.Switch, model = compo.model, ctx = compo.ctx, result = compo.controller;
              resolveNodes(elements, compo.nodes, model, ctx, result);
              var nodes = _nodes, index = _index;
              ...
              elements = Switch[index];
              if (null != elements) {
                els_toggleVisibility(elements, true);
                return;
              }
              result = renderer_render(nodes, model, ctx, null, result);
        ...
        (function() {
          customTag_register('+with', {
            ...
            render: function(model, ctx, container, ctr) {
              var val = this.expression, nodes = this.nodes, val = expression_eval(val, model, ctx, ctr);
            ...
            renderEnd: function(els, compo, ctx, container, ctr) {
              var model = this.rootModel || compo, compo = new WithStatement(this);
              compo.elements = els;
              compo.model = model;
              compo.parent = ctr;
              compo.refresh = fn_proxy(compo.refresh, compo);
      ...
      (function() {
        ...
        (function() {
          ...
          (function() {
            ...
            function call(method, expr, arr, observable, cb) {
              arr = expression_evalStatements(expr, arr, null, observable);
              observable = arr.shift();
          ...
          (function() {
            ...
            RxBinder = class_create(IBinder, {
              stream: null,
              on: function call(arr, stream, ctr, cb) {
                arr = expression_evalStatements(arr, stream, null, ctr);
                stream = arr.shift();
        ...
        customTag_register('listen', class_create({
          ...
          renderEnd: function(Ctor, model, ctx, fn, ctr) {
            _renderPlaceholder(this, this, fn);
            fn = Boolean(this.attr.animatable) ? this.refreshAni : this.refreshSync;
          ...
          getAni: function(name) {
            ...
            ani = Component.child(this, 'Animation#' + name);
            if (null != ani) {
    ...
    (function() {
      (function() {
        ...
        /** Attributes */        function refresherDelegate_ATTR(el, attrName, currentValue) {
          ...
          return function(value) {
            var attr = el.getAttribute(attrName), attr = attr_strReplace(attr, current_, value);
            if (null == attr || '' === attr) {
        ...
        function bind(currentVal, expr, model, ctx, refresher, ctr, ast, type) {
          var owner = 'compo-attr' === type || 'compo-prop' === type ? ctr.parent : ctr;
          refresher = create_refresher(type, expr, refresher, currentVal, ast, ctr);
          ast = expression_parse(expr);
          if (ast.observe) {
        ...
        customUtil_register('bind', {
          ...
          value: null,
          element: null,
          nodeRenderStart: function(ast, model, ctx, el, owner, attrName, type, wValue) {
            owner = 'compo-attr' === type || 'compo-prop' === type ? owner.parent : owner;
            ast = expression_parse(ast, false, wValue);
            wValue = expression_eval_safe(ast, model, ctx, owner, wValue);
            ...
            // utils
            var value = ast.async || ast.observe ? null !== (value = null === wValue || void 0 === wValue ? void 0 : wValue.value) && void 0 !== value ? value : '' : wValue;
          ...
          attrRenderStart: function(ast, model, ctx, el, owner, attrName, type, wValue) {
            owner = 'compo-attr' === type || 'compo-prop' === type ? owner.parent : owner;
            ast = expression_parse(ast, false, wValue);
            wValue = expression_eval_safe(ast, model, ctx, owner, wValue);
            var value = ast.async || ast.observe ? null !== (value = null === wValue || void 0 === wValue ? void 0 : wValue.value) && void 0 !== value ? value : '' : wValue;
  ...
  /**
    ...
    factory: function(compoName) {
      var x = _Array_slice.call(arguments, 1), factory = x.pop(), mode = 'both';
      if (0 !== x.length) {
        x = x[0];
