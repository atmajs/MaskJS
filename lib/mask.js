    ...
    (function() {
          ...
          (function() {
            ...
            PromisedStream = /** @class */ function(_super) {
              ...
              PromisedStream.prototype.then = function(onSuccess, onError) {
                ...
                this._cbs.push([ onSuccess, onError, {
                  once: true
                } ]);
        ...
        (function() {
          (function() {
            ...
            (function() {
              ...
              function toggleExpressionsBindings(fn, mix, model, ctr, cb) {
              ...
              expression_callFn = function(accessor, model, path, obj, args) {
                path = expression_getHost(accessor, model, path, obj);
                if (null != path) {
              ...
              (function() {
                // [ObjectHost, Property]
                var tuple = [ null, null ];
                expression_getHost = function(accessor, model, result, ctr) {
              ...
              function _toggleObserver(mutatorFn, property, obj, accessor, callback) {
                property = expression_getHost(accessor, property, null, obj);
                if (null == property) {
                  return;
                }
      ...
      _evaluate = function(mix, model, ctx, ctr, node) {
        ...
        if ('string' === typeof mix) {
          ...
          ast = null !== (ast = cache[mix]) && void 0 !== ast ? ast : cache[mix] = _parse(mix, false, node_);
        } else {
          ast = mix;
        }
        if (null == ast) {
      ...
      (function() {
        (function() {
          ...
          /**
            ...
            function build(node, children, ctx, tagName, ctr_, type) {
              if (null == node) {
                return container;
              }
              var elements, ctr = ctr_, model = children, children = type, container = tagName, type = node.type;
              if (null == ctr) {
    ...
    (function() {
      ...
      custom_Statements['if'] = {
        ...
        render: function(node, model, ctx, container, ctr, compo) {
          var nodes = expression_getType(node.expression);
          if (nodes === exp_type_Sync) {
            nodes = getNodesSync(node, model, ctx, ctr);
            if (null != nodes) {
              builder_build(nodes, model, ctx, container, ctr, compo);
            }
            return;
          }
          compo = new ObservableIf(node, model, ctx, container, ctr, compo);
          compo_addChild(ctr, compo);
          compo.render();
        }
      };
      ...
      var ObservableNodes = /** @class */ function() {
        ...
        ObservableNodes.prototype.tick = function(err, s, result) {
          if (this.disposed) {
            return;
          }
          s = this.switch[s];
      ...
      var ObservableIf = /** @class */ function() {
        ...
        ObservableIf.prototype.refresh = function(err, owner, frag) {
          var current = this.index, els = this.Switch;
          if (current === frag) {
            return;
          }
          if (current > -1) {
            els_toggleVisibility(els[current].elements, false);
          }
          if (-1 === frag) {
            this.index = -1;
            return;
          ...
          els = current.node.nodes, frag = _document.createDocumentFragment(), owner = {
            components: [],
            parent: this.ctr
    ...
    (function() {
      ...
      (function() {
        ...
        customTag_register('+if', {
          ...
          render: function(model, ctx, container, ctr, children) {
            var node = this;
            var nodes = _getNodes('if', node, model, ctx, ctr);
            var index = 0;
            var next = node;
          ...
          renderEnd: function(els, model, ctx, container, ctr) {
            ...
            var index = this.attr['switch-index'];
        ...
        IFStatement.prototype = {
          ...
          refresh: function() {
            ...
            if (null != frag) {
              els_toggleVisibility(switch_[frag].elements, false);
            }
            if (i === imax) {
              this.index = null;
              return;
            ...
            var _a = switch_[i];
            if (null != _a.elements) {
              els_toggleVisibility(_a.elements, true);
              return;
            }
            var owner = this.node.parent.tagName;
            var _b = 'define' === owner || 'let' === owner;
            var els = _a.node.nodes;
            frag = _document.createDocumentFragment();
            owner = {
              components: [],
              parent: ctr
            };
            els = compo_renderElements(els, model, ctx, frag, owner);
            dom_insertBefore(frag, this.placeholder);
            _a.elements = els;
            ...
            (_a = ctr.components).push.apply(_a, owner.components);
            if (_b) {
              // we add also the elements to parents set, in case the +if was the root node.
              null === (_b = ctr.$) || void 0 === _b ? void 0 : _b.add(els);
            }
          },
          dispose: function() {
        ...
        function initialize(ifCtr, nodeCtr, index, elements, model, ctx, container, parentCtr) {
          ...
          while (true) {
            ...
            if (null == nodeCtr || 'else' !== nodeCtr.tagName) {
              break;
            }
            ifCtr.Switch.push({
              node: nodeCtr,
      ...
      (function() {
        (function() {
          ...
          list_update = function(self, deleteIndex, deleteCount, insertIndex, rangeModel) {
            ...
            var ctx = self.ctx, fragment = self.node;
            ...
            if (null != insertIndex && rangeModel && rangeModel.length) {
              var imax, i = compos.length, fragment = self._build(node, rangeModel, ctx, fragment), new_ = compos.splice(i);
          ...
          LoopStatementProto = {
            ...
            refresh: function(value, method, args, result) {
              ...
              if (null == method) {
                ...
                frag = this._build(node, value, ctx, frag);
                if (null != frag) {
                  dom_insertBefore(frag, this.placeholder);
        ...
        customTag_register('+for', {
          ...
          render: function(model, ctx, container, value, children) {
            ...
            value = expression_eval(directive[3], model, ctx, value);
            if (null == value) {
              return;
            }
            if (is_Array(value)) {
        ...
        ForStatement.prototype = {
          ...
          _build: function(node, nodes, ctx, component) {
            nodes = For.getNodes(node.nodes, nodes, this.prop1, this.prop2, this.type);
    ...
    (function() {
      (function() {
        ...
        customUtil_register('bind', {
          ...
          current: null,
          element: null,
          nodeRenderStart: function(ast, model, ctx, el, owner, attrName, type, current) {
            owner = 'compo-attr' === type || 'compo-prop' === type ? owner.parent : owner;
            ast = expression_parse(ast, false, current);
            current = expression_eval_safe(ast, model, ctx, owner, current);
            ...
            // utils
            var value = ast.async || ast.observe ? null !== (value = null === current || void 0 === current ? void 0 : current.value) && void 0 !== value ? value : '' : current;
          ...
          attrRenderStart: function(expr, model, ctx, el, owner, attrName, type, node) {
            owner = 'compo-attr' === type || 'compo-prop' === type ? owner.parent : owner;
            return this.current = expression_eval_safe(expr, model, ctx, owner, node);
          },
          attr: function(expr, model, ctx, el, ctr, attrName, type) {
            bind(this.current, expr, model, ctx, el, ctr, attrName, type);
            return this.current;
          }
        });
      })();
